...
### [1] [Probing the matter-dominated expansion with multi-redshift Lyman-$α$ BAO from DESI DR2](https://arxiv.org/abs/2607.19619)
...
### [2] [Dynamical Test of Cosmic Acceleration: $k$-nearest Neighbor Cross Correlation of Cosmic Microwave Background and Cosmic Infrared Background](https://arxiv.org/abs/2607.19648)
...
### [3] [Constraining Effective Viscosity in the Intracluster Medium via the Thermal Sunyaev-Zeldovich Effect -- Predictions from the SLOW Constrained Coma Cluster Simulations](https://arxiv.org/abs/2607.19753)
...
### [4] [Accurate parameter inference for the Light-cone Epoch of Reionization 21-cm signal](https://arxiv.org/abs/2607.19792)
...
### [5] [QCD CP-violation scenario for a revised cosmological dynamics: analysis of the binned Pantheon Sample of Super Novae Ia](https://arxiv.org/abs/2607.19915)
...
### [6] [Ringing of the Reionization: A first direct measurement of the intergalactic pressure smoothing scale at redshift z>4.2 as imprinted onto small-scale peculiar velocities in the Lyman-alpha forest](https://arxiv.org/abs/2607.19938)
...
### [7] [Modeling the HI-Halo Connection: Evolution, Scatter, and a Halo-based Prescription for 21-cm Mock Catalogs](https://arxiv.org/abs/2607.20123)
...
### [8] [Can cosmic voids ease the Hubble tension? Local expansion in $w_0w_a$CDM](https://arxiv.org/abs/2607.20257)
...
### [9] [Interacting Dark Energy and Dark Matter in O(3) No-Scale Gravity](https://arxiv.org/abs/2607.20320)
...
### [10] [Beyond $j=1$: Observational Constraints on Almost-$Λ$CDM Cosmologies](https://arxiv.org/abs/2607.20348)
...
### [11] [The burgeoning rise of the 21-cm forest I: constraints on the optical depth of the intergalactic medium at $5.38 < z < 5.84$](https://arxiv.org/abs/2607.20371)
...
### [12] [The road towards precision measurements of $H_0$ with bright sirens in the Einstein Telescope era](https://arxiv.org/abs/2607.20413)
...
### [13] [Primordial black holes forming during kination: the trapped, the overdense, and the void](https://arxiv.org/abs/2607.20423)
*Cristian Joana*
...
### [14] [The Runkel-Watts string](https://arxiv.org/abs/2607.19462)
...
### [15] [Conformal QED in AdS as a BCFT](https://arxiv.org/abs/2607.19464)
...
### [16] [Confinement Versus Screening in the Schwinger Model on AdS$_2$ from Bosonization and Tensor Networks](https://arxiv.org/abs/2607.19468)
...
### [17] [Point-Like Charges and Dirichlet Boundary Conditions in a Nonlocal Scalar Field Theory](https://arxiv.org/abs/2607.19709)
...
### [18] [Resolved Maxwell-Boundary Normal Forms and Exact Reentrant Scaling in Accelerating AdS Black Holes](https://arxiv.org/abs/2607.19748)
*Ruiliang Li*
...
### [19] [Real Quantum Field Theory, J-Quantization, and Standard Model](https://arxiv.org/abs/2607.20304)
...
### [20] [Three-dimensional TQFTs from Argyres--Douglas theories via the 3d/3d correspondence](https://arxiv.org/abs/2607.20308)
...
### [21] [Higher Superspace Supergravity and its IR-Completions](https://arxiv.org/abs/2607.20312)
...
### [22] [Resolution of Gauss' law in the maximal Abelian gauge](https://arxiv.org/abs/2607.20313)
...
### [23] [Neutrino t-channels at Colliders: When Light Neutrinos Matter](https://arxiv.org/abs/2607.19461)
...
### [24] [Can the universe be matter-dominated after a supercooled first-order phase transition?](https://arxiv.org/abs/2607.19469)
...
### [25] [Power of Axion Microwave Absorbed by Quantum Hall State in Haloscope](https://arxiv.org/abs/2607.19888)
*Aiichi Iwazaki*
...
### [26] [Monopoles, Strings, Walls and Gravitational waves](https://arxiv.org/abs/2607.20340)
...
### [27] [PDF at small $x$ in the non-perturbative region](https://arxiv.org/abs/2601.12489)
*M. L. Nekrasov*
...
### [28] [Instability of regular black holes in non-minimally coupled scalar field theories: an analytical approach](https://arxiv.org/abs/2607.19755)
...
### [29] [Energy Flux as an Entanglement Current in Moving-Mirror Radiation](https://arxiv.org/abs/2607.19763)
...
### [30] [Circular-orbit dynamics and QPO constraints in static Einstein--scalar--Gauss--Bonnet black holes](https://arxiv.org/abs/2607.19805)
...
### [31] [Characterization of the Scattered Light Noise in KAGRA Interferometer](https://arxiv.org/abs/2607.19814)
...
### [32] [Coordinate Independence of the Schwarzschild Black Hole Accretion Vlasov Gas Model](https://arxiv.org/abs/2607.19815)
...
### [33] [Quasinormal modes of the Kazakov--Solodukhin quantum-corrected black hole: a spectral analysis](https://arxiv.org/abs/2607.19860)
...
### [34] [Intermittency in Quantum Graviton-Phonon Conversion](https://arxiv.org/abs/2607.20107)
...
### [35] [Quasinormal modes of scalar and Maxwell field perturbations coupled to the Einstein tensor in generalized Nariai spacetimes](https://arxiv.org/abs/2607.19863)
...
### [36] [Geometry-Induced Termination of the Repetitive Penrose Process in Rotating Simpson-Visser Black Holes](https://arxiv.org/abs/2607.19904)
...
### [37] [What may come beyond the Wheeler-DeWitt approach?](https://arxiv.org/abs/2607.19958)
*T. P. Shestakova*
...
### [38] [Cosmological horizon thermodynamics in Gauss-Bonnet quasi-dilaton Massive Gravity](https://arxiv.org/abs/2607.20112)
...
### [39] [Tachyonic modes as a resonant system in weakly curved stellar spacetimes](https://arxiv.org/abs/2607.19474)
...
### [40] [Parity-violating spatially covariant gravity at total derivative order $d=5$](https://arxiv.org/abs/2607.20317)
...
### [41] [Schrödinger perturbation theory for black hole quasinormal modes](https://arxiv.org/abs/2607.19492)
