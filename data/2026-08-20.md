...
### [1] [Dianoga simulations of galaxy clusters and groups: Properties of the baryonic components](https://arxiv.org/abs/2608.17570)
...
### [2] [A stochastic forward model for the intergalactic dispersion-measure distribution of Fast Radio Bursts](https://arxiv.org/abs/2608.17658)
...
### [3] [Infrared Lines from Sterile-Neutrino Transition Magnetic Moments at JWST](https://arxiv.org/abs/2608.17679)
...
### [4] [Large eROSITA X-ray sources as 2MRS galaxy groups](https://arxiv.org/abs/2608.17732)
...
### [5] [Imprints of Mass Accretion History on Galaxy Cluster Morphology](https://arxiv.org/abs/2608.18031)
...
### [6] [Dark Energy in the $w-c_s^2$ Plane](https://arxiv.org/abs/2608.17208)
...
### [7] [Spectral Fingerprints Beyond Degeneracies in Primordial Gravitational-Wave Sources](https://arxiv.org/abs/2608.17002)
*Subhasis Maiti*
...
### [8] [Rational regular black holes in non-polynomial gravity](https://arxiv.org/abs/2608.17158)
*Aimeric Colléaux*
...
### [9] [Removability criterion for radiative corrections to the Starobinsky attractor in weakly nonlocal gravity](https://arxiv.org/abs/2608.17215)
...
### [10] [Ostrogradsky's Theorem is Incompatible with Background Independence in Quantum Gravity](https://arxiv.org/abs/2608.17364)
*Ken-ji Hamada*
...
### [11] [Vacuum Polarization in Quantum-Corrected and Effective Black Hole Geometries: a High Performance Approach](https://arxiv.org/abs/2608.17670)
*Antonino Flachi*
...
### [12] [Thermomechanics of Horndeski Scalar Hair with Spacelike Gradients](https://arxiv.org/abs/2608.17730)
...
### [13] [Gravitational Waves from Green's Function Decomposition for a Kerr black hole: I. Equatorial ISCO Plunge](https://arxiv.org/abs/2608.17943)
...
### [15] [Astrophysical Graviton Squeezing Can Be Hidden in the Far-Field](https://arxiv.org/abs/2608.17015)
...
### [16] [The high-energy behavior of tree-level scattering in finite-temperature QCD: estimates of theoretical systematic uncertainty in jet-medium Monte Carlo simulations](https://arxiv.org/abs/2608.17160)
...
### [17] [Closed-form expressions for tree-level gluon-gluon scattering: a framework for obtaining theoretical systematic uncertainties for jet-medium Monte Carlo simulations](https://arxiv.org/abs/2608.17161)
*Lukas Opitz,Hemanth Regi,Gojko Vujanovic*
...
### [18] [Reply to "Revisiting bounds on neutrino dark matter interaction at spikes"](https://arxiv.org/abs/2608.17236)
...
### [19] [Lepton flavor violating decays $l_j \rightarrow l_iγ$ in the $U(1)_X$VLFM](https://arxiv.org/abs/2608.17309)
...
### [20] [From the universal Lindblad equation to Boltzmann equations: in-QGP quarkonium dynamics](https://arxiv.org/abs/2608.17372)
...
### [21] [Seeding baryonic dark matter](https://arxiv.org/abs/2608.17395)
*Domenec Espriu*
...
### [22] [Static and dynamic properties of Triply Heavy Baryons](https://arxiv.org/abs/2608.17413)
...
### [23] [Characterize the properties of $D_s^+$-meson decay constant and leptonic decays by using QCD sum rules within background field theory framework](https://arxiv.org/abs/2608.17483)
...
### [24] [VERaiPHY -- Validation & Evaluation for Robust AI in PHYsics](https://arxiv.org/abs/2608.17724)
...
### [25] [An Exact Analytical Bridge from Complex Yukawa Couplings to Fermion Masses and CKM/PMNS Mixing](https://arxiv.org/abs/2608.17491)
*Chilong Lin*
...
### [26] [Effective propagators of flavor neutrinos](https://arxiv.org/abs/2608.16933)
*Maxim Dvornikov*
...
### [27] [Anomaly-Induced Phenomena with Massive Fermions: Higher-Landau-Level Dominance from Spatially Modulated Electric Fields](https://arxiv.org/abs/2608.17611)
...
### [28] [Probing the Internal Structure of $X(3872)$ via Magnetic Moment: Distinguishing Color-Singlet and Compact Configurations](https://arxiv.org/abs/2608.17090)
...
### [29] [Precise Measurement of $δ$ at LBNE Using Only The Neutrino Sector](https://arxiv.org/abs/2608.17676)
*Emilio Ciuffoli*
...
### [30] [An axion constraint from the diffuse supernova neutrino background indicated by Super-Kamiokande](https://arxiv.org/abs/2608.17681)
...
### [31] [Entanglement of back-to-back gluon pair](https://arxiv.org/abs/2608.17685)
...
### [32] [Bound-state spectra of $χ_{cJ}$ in finite nuclei and the universal pattern of mass levels](https://arxiv.org/abs/2608.17737)
...
### [33] [Resolved Photon Processes: A Tribute to Rohini Godbole](https://arxiv.org/abs/2608.17864)
*Manuel Drees*
...
### [34] [Can $γγ$ collisions rival $e^-e^+$ in probing doubly charged Higgs bosons?](https://arxiv.org/abs/2608.18023)
...
### [35] [Robin boundary conditions in global AdS$_4$: exact double-trace thermodynamics and a soft-mode instability](https://arxiv.org/abs/2608.17064)
...
### [36] [Variable-mass sine-Gordon with point defects: integrability, soliton transmission, and quasi-conservation](https://arxiv.org/abs/2608.17211)
...
### [37] [Elliptic spin Ruijsenaars-Schneider integrable models from 5d $\mathcal{N}=1$ gauge theories](https://arxiv.org/abs/2608.17837)
...
### [38] [A compact analytic formula for the one-loop triangle cosmological correlator](https://arxiv.org/abs/2608.17877)
...
### [40] [Gravity and Matter from Soldered Chiral Superconnections](https://arxiv.org/abs/2608.17900)
...
### [42] [Gravitational Compton scattering at the fifth post-Minkowskian order](https://arxiv.org/abs/2608.17946)
...
### [43] [Who Writes the Gravitational Second Law of Thermodynamics?](https://arxiv.org/abs/2608.16997)
...
### [44] [Analytic Continuation of Conformal Integrals in Momentum Space](https://arxiv.org/abs/2608.18073)
...
### [45] [Deconfinement-Higgs continuity in ${\rm SU(2)}$ adjoint Higgs model at finite temperature](https://arxiv.org/abs/2510.15493)
