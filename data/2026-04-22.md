...
TL;DR: We study the sensitivity of future MeV gamma-ray telescopes to sterile neutrino dark matter, finding that they can significantly tighten constraints on decay rates, enhancing our ability to probe this dark matter candidate.


<details>
  <summary>Details</summary>
Motivation: To investigate the sensitivities of upcoming MeV gamma-ray telescopes to sterile neutrino dark matter in the mass range $(0.2-100)\,{\rm MeV}$, focusing on observable photon signals through radiative two-body decays and three-body decays with final-state radiation.

Method: A Fisher forecasting analysis was performed, incorporating realistic astrophysical background modeling and detector response to derive projected constraints on the sterile neutrino decay rate.

Result: Future MeV instruments can improve existing limits by several orders of magnitude across a wide region of parameter space.

Conclusion: Future MeV gamma-ray telescopes can significantly enhance the constraints on sterile neutrino decay rates, improving existing limits by several orders of magnitude across a wide region of parameter space. This highlights the discovery potential of next-generation MeV telescopes in probing sterile neutrino dark matter.
...
TL;DR: This paper improves the theoretical understanding of bremsstrahlung by incorporating quantum effects from pair production within the LPM framework, applicable to ultra-relativistic electrons and photons.


<details>
  <summary>Details</summary>
Motivation: The motivation stems from the qualitative incompleteness of the existing theory of bremsstrahlung involving extremely high energy electrons passing through ordinary matter. The aim is to improve the theoretical framework by considering the LPM effect and quantum disruptions caused by pair production.

Method: The method involves revisiting the Landau-Pomeranchuk-Migdal (LPM) effect and accounting for quantum disruption due to pair production. The analysis is conducted over the full range of ultra-relativistic electron and photon energies, with some simplifying approximations applied.

Result: The result is a refined theoretical model that better captures the suppression of bremsstrahlung by the LPM effect, taking into account quantum effects from pair production. This leads to a more accurate description of the process across the specified energy ranges.

Conclusion: The analysis provides a more comprehensive understanding of the bremsstrahlung process, particularly in the context of ultra-relativistic electrons and photons, by incorporating quantum effects related to pair production.
...
TL;DR: This paper develops a new method for studying flavor instabilities in neutrino plasmas, focusing on the role of matter gradients in supernovae. It finds that while these gradients slow down instability growth, they do not eliminate it, emphasizing the need for a coupled analysis of local and global effects.


<details>
  <summary>Details</summary>
Motivation: Flavor instabilities in neutrino plasmas are studied due to their potential impact on cosmological processes, such as the evolution of large-scale structure. The motivation is to understand how these instabilities evolve globally, considering the effects of matter gradients in supernovae environments.

Method: The method involves deriving flavomon equations of motion in slowly varying environments, constructing a flavomon ray tracing framework, and combining it with a quasi-linear description of flavomon growth to develop a new approach to the global evolution of flavor instabilities.

Result: The result shows that matter gradients in supernovae environments slow down the growth of neutrino-mass-induced flavor instabilities but do not completely suppress them. This finding underscores the importance of using a combined approach involving both local stability analysis and flavomon ray tracing to fully capture the dynamics of these instabilities.

Conclusion: The study introduces a novel approach to the global evolution of flavor instabilities in neutrino plasmas by developing flavomon equations of motion and a ray tracing framework. It demonstrates that matter gradients slow down but do not suppress the growth of neutrino-mass-induced instabilities, highlighting the necessity of coupling local stability analysis with flavomon ray tracing for a comprehensive understanding.
...
TL;DR: We introduce a method to determine the mass scale of ambient dark matter using two-dimensional direct detection experiments. By analyzing the directional preference in dark-matter flux, we demonstrate that the curvature of the angular spectrum encodes mass information. Numerical validation is provided using a Graphene-Josephson-Junction-based superlight dark-matter detector.


<details>
  <summary>Details</summary>
Motivation: To address the challenge of determining the mass scale of ambient dark matter, which is crucial for understanding the nature of dark matter and its role in cosmology. Traditional methods often lack the sensitivity to capture directional observables, whereas the proposed method leverages the unique properties of two-dimensional direct detection experiments to extract mass information from the dark-matter flux.

Method: A novel method is developed to analyze the angular spectrum of dark-matter event rates, which depends on the angle between the detection plane and the overall dark-matter flow. The curvature of this angular spectrum encodes information about the mass scale of ambient dark matter. Numerical simulations are conducted using a Graphene-Josephson-Junction-based superlight dark-matter detector to validate the theoretical expectations.

Result: The results show that the angular spectrum of dark-matter event rates exhibits a non-trivial dependence on the angle between the detection plane and the overall dark-matter flow. The curvature of this angular spectrum can be used to infer the mass scale of ambient dark matter. Numerical analyses confirm these theoretical expectations using a specific superlight dark-matter detector.

Conclusion: The proposed method provides a novel approach to determine the mass scale of ambient dark matter, leveraging the directional preference in dark-matter flux observed by two-dimensional direct detection experiments. This method is demonstrated through numerical analyses using a specific superlight dark-matter detector, validating the theoretical predictions.
...
TL;DR: Based on JUNO's first oscillation results, we analyzed the viability of texture zeros in the Dirac neutrino mass matrix. Current JUNO data disfavor texture $C$, leaving only $A_2$ and $A_1$ as viable options.


<details>
  <summary>Details</summary>
Motivation: Motivated by the first oscillation results from JUNO, the study aims to scrutinize predictive texture zero frameworks in the context of the Dirac neutrino mass matrix.

Method: A systematic scan of the allowed parameter space for two-zero textures was performed to identify sharp correlations among oscillation observables arising from the reduced parameter space.

Result: Our analysis reveals that although textures $C$, $A_2$, and $A_1$ were previously viable, current JUNO data strongly disfavor $C$, leaving only textures $A_2$ and $A_1$ compatible with the data. This highlights the remarkable sensitivity of Dirac texture zero scenarios to the solar sector.

Conclusion: The current JUNO measurements impose stringent constraints on the viable texture structures for Dirac neutrino mass matrix, particularly disfavoring the texture $C$ and leaving only textures $A_2$ and $A_1$ compatible with the data.
...
TL;DR: This paper reviews the current understanding of IR singularities in multileg QCD amplitudes and introduces a new method using a lightcone expansion to compute the soft anomalous dimension. The method has been applied to determine the three-loop soft anomalous dimension for a single massive particle with massless ones, paving the way for future computations involving two heavy particles at higher loop orders.


<details>
  <summary>Details</summary>
Motivation: To address the remarkable simplicity of the soft anomalous dimension in the context of IR singularities in multileg QCD amplitudes, and to develop a more efficient computational method for determining this quantity, especially for higher loop orders involving multiple heavy particles.

Method: A novel strategy employing a lightcone expansion of correlators of semi-infinite Wilson lines through the Method of Regions is presented. This method involves breaking down the problem into regions of integration and applying asymptotic expansions to simplify the calculation of the soft anomalous dimension.

Result: The result of this work includes the successful computation of the three-loop soft anomalous dimension for amplitudes containing a single massive coloured particle with any number of massless ones. This achievement opens up the possibility of extending the method to compute the same quantity for two heavy particles at three loops and beyond.

Conclusion: The review highlights the state-of-the-art knowledge of IR singularities in multileg QCD amplitudes, emphasizing the simplicity of the soft anomalous dimension. A novel method using a lightcone expansion of correlators of semi-infinite Wilson lines by the Method of Regions is introduced, which has been successfully applied to determine the three-loop soft anomalous dimension for single massive coloured particles with any number of massless ones. This approach paves the way for computing this quantity for two heavy particles at three loops and potentially higher loop orders.
...
TL;DR: This paper computes the decay widths and branching fractions for $Z 	o J/ψ+Υ(nS)$ ($n=1,2,3$) at future super $Z$ factory and CEPC/FCC-ee, considering relativistic and QCD corrections. Higher-order corrections are found to be significant and reduce decay widths substantially. These corrections are essential for accurate estimations, and the $Z$-boson resonance effect can produce sizable event rates at high-luminosity electron positron colliders.


<details>
  <summary>Details</summary>
Motivation: The motivation is to study the decays $Z 	o J/ψ+Υ(nS)$ ($n=1,2,3$) with detailed consideration of relativistic and QCD corrections. This is crucial for understanding the precision physics at future high-energy colliders and for improving theoretical predictions of particle decay processes.

Method: The method involves calculating decay widths and branching fractions using nonrelativistic QCD, including relativistic and QCD corrections. The calculations are performed at future super $Z$ factory and CEPC/FCC-ee, focusing on the effects of higher-order corrections.

Result: The results show that both relativistic and QCD corrections are large and negative, significantly reducing the decay widths compared to leading-order results. This indicates the importance of including higher-order corrections for reliable estimations. At high-luminosity electron positron colliders near the $Z$-pole, the $Z$-boson resonance effect can lead to sizable event rates from these rare decay channels.

Conclusion: The paper calculates the decay widths and branching fractions for $Z 	o J/ψ+Υ(nS)$ ($n=1,2,3$) at future super $Z$ factory and CEPC/FCC-ee, incorporating relativistic and QCD corrections within nonrelativistic QCD. The higher-order corrections are significant and negative, leading to a substantial reduction in decay widths compared to leading-order results. These corrections must be considered for accurate estimations. At high-luminosity electron positron colliders operating near the $Z$-pole, these rare decay channels can produce sizable event rates due to the $Z$-boson resonance effect.
...
TL;DR: We analyze charmless non-leptonic B-to-PP decays using experimental data on branching ratios and CP asymmetries, finding a good fit to current data with QCD-factorization amplitudes resembling dynamical predictions. No strong evidence of enhanced annihilation amplitudes was observed.


<details>
  <summary>Details</summary>
Motivation: To perform a comprehensive analysis of charmless non-leptonic B-to-PP decays using experimental data on branching ratios and CP asymmetries, aiming to understand the underlying dynamics and resolve flavor puzzles.

Method: A data-driven analysis using branching ratios and CP asymmetries, incorporating flavor-SU(3) breaking at the level of transition form factors, decay constants, and phase space factors. The analysis employs QCD-factorization amplitudes.

Result: The analysis yields a good fit to the current experimental data, with central values of QCD-factorization amplitudes matching many features of dynamical predictions within the QCD factorization framework. No strong indications of numerical enhancement of annihilation amplitudes beyond the naive ΛQCD/m_b scaling were found.

Conclusion: The analysis provides a good fit to the current experimental data for charmless non-leptonic B-to-PP decays, with QCD-factorization amplitudes resembling dynamical predictions within the QCD factorization framework. There is no strong evidence that annihilation amplitudes are numerically enhanced beyond the naive ΛQCD/m_b scaling. The findings address several long-standing flavor puzzles in non-leptonic B decays.
...
TL;DR: This paper explores the implications of the Hawking area law on quantum gravity by analyzing gravitational wave mergers observed by LIGO--Virgo--KAGRA. It shows that these mergers can be explained by local Stelle gravity and nonlocal quantum-gravity theories under specific conditions, leading to the strongest simplification of theoretical ambiguities. Additionally, it proves the classical standard black-hole entropy-area law and provides a rigorous framework for Barrow's fractal black holes.


<details>
  <summary>Details</summary>
Motivation: The motivation behind this work is to understand the profound consequences of the Hawking area law on quantum gravity. By verifying this law through the observation of gravitational wave mergers, the study aims to simplify the theoretical ambiguities in certain classes of quantum-gravity theories and provide a more robust understanding of black-hole physics and the relationship between classical and quantum mechanics.

Method: The method involves analyzing the observed mergers of gravitational waves from LIGO--Virgo--KAGRA and examining the theoretical frameworks that can explain these observations under the assumption of the exact Hawking area law. This includes studying local Stelle gravity and nonlocal quantum-gravity theories with specific constraints on the form factors and the action. The analysis also involves proving the classical standard black-hole entropy-area law as a consequence of the Hawking area law and providing a rigorous framework for Barrow's fractal black holes.

Result: The results show that the observed gravitational wave mergers can be produced in local Stelle gravity and nonlocal quantum-gravity theories under very restrictive conditions, which include the absence of $R^2$ and (Riemann)${}^2$ terms in the action, the absence of extra real poles in the graviton propagator, and the positivity of its spectral representation. This is the strongest simplification of the ambiguities in this class of theories. Furthermore, the classical standard black-hole entropy-area law is proven to hold as a consequence of the Hawking area law, and a rigorous realization of Barrow's fractal black holes is demonstrated.

Conclusion: The LIGO--Virgo--KAGRA verification of the Hawking area law has significant implications for quantum gravity if it is assumed to hold exactly. The observed mergers can be explained by local Stelle gravity or nonlocal quantum-gravity theories with specific conditions, including the absence of certain terms in the action and the positivity of the spectral representation of the graviton propagator. This represents the strongest simplification of the ambiguities in this class of theories. Additionally, the classical standard black-hole entropy-area law is shown to follow from the Hawking area law, and a rigorous realization of Barrow's fractal black holes is provided.
...
TL;DR: The paper investigates the properties of foliations in non-metric geometry, derives the generalized Gauss-Codazzi relations, and constructs the Hamiltonian for the symmetric teleparallel equivalent of General Relativity, demonstrating that it has the same number of degrees of freedom as its Riemannian counterpart.


<details>
  <summary>Details</summary>
Motivation: To understand the properties of foliations in non-metric geometry and to develop a consistent framework for the teleparallel approach to non-metric theories, which can provide insights into the dynamics of spacetime without relying on the metric tensor.

Method: The authors derive generalized Gauss-Codazzi relations in the presence of non-metricity, study the constraints on extrinsic and intrinsic tensors, analyze the variational principle with boundary terms, and construct the Hamiltonian of the symmetric teleparallel equivalent of General Relativity.

Result: The paper derives the generalized Gauss-Codazzi relations, identifies the role of an extrinsic symmetric two-tensor as the extrinsic curvature, and constructs the Hamiltonian for the symmetric teleparallel equivalent of General Relativity. It also shows that this theory is well-posed and well-defined, sharing the same number of degrees of freedom as the Riemannian version.

Conclusion: The paper demonstrates that the symmetric teleparallel equivalent of General Relativity has the same number of degrees of freedom as its Riemannian counterpart, and it provides a Hamiltonian formulation for this theory.
...
TL;DR: This paper proposes that the quantum nature of spacetime, including a non-commutative dual companion, gives rise to an intrinsic probabilistic and contextual nature of quantum theory with a fixed Born rule. In quantum gravity, this results in a background-independent structure with dynamical and contextual quantum probabilities, leading to triple and higher-order interference for massive quantum probes, with implications for string theory and particle masses.


<details>
  <summary>Details</summary>
Motivation: The motivation is to understand the quantum nature of spacetime and how it influences the probabilistic and contextual aspects of quantum theory, particularly in the context of quantum gravity. This work seeks to provide a theoretical framework that can explain phenomena such as string theory, vacuum energy, and particle masses through the lens of a quantum spacetime.

Method: The method involves formulating quantum theory within a classical spacetime, recognizing the quantum nature of spacetime itself, which includes a non-commutative dual companion to the classical spacetime. The approach aims to integrate quantum theory into a background-independent structure with dynamical and contextual quantum probabilities.

Result: The result is a proposal that quantum theory, when applied to spacetime, exhibits an intrinsic probabilistic and contextual nature due to the quantum nature of spacetime itself. This leads to a background-independent structure in quantum gravity with dynamical and contextual quantum probabilities, suggesting triple and higher-order interference effects for massive quantum probes.

Conclusion: The proposed framework suggests that the quantum nature of spacetime, with its non-commutative dual companion, leads to an intrinsic probabilistic and contextual nature of quantum theory, including a fixed Born rule. In quantum gravity, this results in a background-independent structure with dynamical and contextual quantum probabilities, implying intrinsic triple and higher-order interference for massive quantum probes. This has implications for string theory and the observed vacuum energy as well as particle masses.
...
TL;DR: This work examines cosmological models based on generalized horizon entropies using BBN constraints, finding that the models are viable with consistent helium and deuterium bounds, and late-time acceleration parameters within BBN limits.


<details>
  <summary>Details</summary>
Motivation: To investigate the viability of cosmological models derived from generalized horizon entropies using BBN constraints.

Method: The method involves analyzing deviations in the expansion rate to derive bounds on model parameters from freeze-out temperature, helium, and deuterium abundances. The analysis also considers lithium constraints and late-time cosmic acceleration.

Result: The freeze-out condition provides the most stringent constraint, while helium and deuterium bounds remain consistent across all models. Late-time cosmic acceleration parameter values are found to be within the BBN bounds, demonstrating consistency between early- and late-Universe behavior. Lithium constraints are not satisfied due to the cosmological lithium problem.

Conclusion: The considered cosmological models are viable within the framework of Big Bang Nucleosynthesis (BBN) constraints.
...
TL;DR: This thesis explores fundamental aspects of general relativity through a structured mathematical approach, focusing on hypersurface data, characteristic and Killing problems, metric expansions, and conformal null infinity.


<details>
  <summary>Details</summary>
Motivation: The motivation is to develop a unified and rigorous mathematical framework that can be applied to a wide range of problems in general relativity, enhancing our understanding of spacetime structures and dynamics.

Method: The method involves a systematic approach to mathematical relativity, utilizing the formalism of hypersurface data, detached perspectives on characteristic and Killing problems, and detailed analysis of metric expansions and conformal null infinity.

Result: The results include a thorough exploration of the mathematical tools and concepts necessary for advanced studies in general relativity, such as the development of new formalisms and insights into the behavior of spacetime near null singularities.

Conclusion: The thesis provides a comprehensive framework for studying various aspects of general relativity, including hypersurface data formalism, characteristic Cauchy problem, Killing initial data problem, metric expansion at null hypersurfaces, and conformal null infinity geometry.
...
TL;DR: This paper explores the phenomenon of mass inflation in black hole horizons and demonstrates how to construct stable black hole solutions with multiple horizons and a nonlinear Maxwell field by ensuring that the inner horizons have vanishing surface gravities.


<details>
  <summary>Details</summary>
Motivation: The motivation for this research is to understand the stability of black hole horizons and the phenomenon of mass inflation. By modifying the properties of the inner horizon, the authors aim to construct stable black hole solutions without mass inflation, which could provide insights into the fundamental nature of black holes and their interactions with electromagnetic fields.

Method: The method involves studying the behavior of perturbations near the inner horizon in two-horizon spacetime, showing that mass inflation occurs due to the exponential growth of initially small perturbations. The authors then modify the black hole solutions by making the surface gravity of the inner horizon vanish, leading to the absence of mass inflation. This is achieved by constructing black hole solutions with multiple horizons and a nonlinear Maxwell field, where the inner horizons are made to coincide and have zero surface gravities.

Result: The results show that by adjusting the properties of the inner horizon, specifically by setting the surface gravity to zero, the exponential growth character of mass inflation can be eliminated. Consequently, the authors are able to construct black hole solutions with multiple horizons and a nonlinear Maxwell field, where the inner horizons coincide and have vanishing surface gravities, thus avoiding mass inflation.

Conclusion: The paper demonstrates the construction of black hole solutions with multiple horizons and a nonlinear Maxwell field, ensuring that the inner horizons coincide and have vanishing surface gravities, thereby eliminating mass inflation.
...
TL;DR: This work aims to detect a stochastic gravitational wave background in the mHz band by analyzing the spatial distribution of binary systems and modeling the foreground. It demonstrates that this approach can provide preliminary feasible results under certain assumptions about the statistical properties of the foreground.


<details>
  <summary>Details</summary>
Motivation: To address the challenges of detecting a stochastic gravitational wave background in the mHz band, which is complicated by the presence of numerous compact binaries in our galaxy. The goal is to accurately estimate the confusion foreground created by the superposition of gravitational waves from their inspiral stages.

Method: Deriving the variation in the intensity of detector response to the foreground by analyzing the spatial distribution of binary systems, and searching for an injected stochastic background using the modeled foreground within Taiji Data Challenge II.

Result: The results show that the approach of describing foreground based on the population properties of resolved Galactic binaries can yield preliminary feasible results.

Conclusion: The approach of describing foreground based on the population properties of resolved Galactic binaries can yield preliminary feasible results.
...
TL;DR: This paper reevaluates the merger rate of primordial black hole binaries, incorporating clustering effects. It finds that weak clustering allows for a lower $f_{\mathrm{PBH}}$ to explain LIGO-Virgo-KAGRA events, but strong clustering suppresses the two-body merger rate due to three-body system formation.


<details>
  <summary>Details</summary>
Motivation: Motivated by binary black-hole merger events detected by gravitational-wave interferometers, the motivation is to reassess the merger rate of PBH binaries and to explore how clustering affects these rates. The goal is to understand the implications of different clustering scenarios on the observed event rates.

Method: The method involves revisiting the evaluation of the merger rate of PBH binaries and extending the formalism to incorporate clustering effects. This includes analyzing the impact of different levels of PBH clustering on the merger rates observed by gravitational-wave interferometers such as LIGO-Virgo-KAGRA.

Result: The results show that under relatively weak PBH clustering, the merger rates observed by LIGO-Virgo-KAGRA can be explained with a lower value of $f_{\mathrm{PBH}}$ than in scenarios with Poisson-distributed PBHs, particularly in the early two-body channel. However, for stronger clustering, the merger rate in the two-body channel is notably reduced due to the formation of three-body systems.

Conclusion: The study revisits the evaluation of the merger rate of primordial black hole (PBH) binaries, extending the formalism to include clustering effects. It demonstrates that in scenarios with weak PBH clustering, the LIGO-Virgo-KAGRA events can be explained with a smaller value of $f_{\mathrm{PBH}}$ compared to Poisson-distributed PBHs, at least in the early two-body channel. However, for stronger clustering, the merger rate in the two-body channel is significantly suppressed due to the formation of three-body systems.
...
### [50] [Tree Amplitudes with Charged Matter in Pure Gauge Theory](https://arxiv.org/abs/2604.18672)
...
### [51] [Neural Networks Reveal a Universal Bias in Conformal Correlators](https://arxiv.org/abs/2604.18673)
*Kausik Ghosh,Sidhaarth Kumar,Vasilis Niarchos,Andreas Stergiou*

Main category: hep-th

TL;DR: We propose using simple neural networks trained on crossing symmetry to accurately reconstruct conformal correlators restricted to a line, achieving remarkable accuracy across various conformal theories and dimensions. This approach leverages the spectral bias of gradient-based NN training and suggests a novel variational principle for conformal correlators, opening up new avenues for computational frameworks in non-perturbative quantum field theory.


<details>
  <summary>Details</summary>
Motivation: To explore the potential of using machine learning techniques, specifically neural networks, in reconstructing conformal correlators within the context of quantum field theory. The motivation is driven by the desire to leverage the power of machine learning to address challenges in non-perturbative quantum field theory, where traditional methods may be insufficient.

Method: Simple neural networks (NNs) trained on crossing symmetry are used to reconstruct conformal correlators restricted to a line. The input includes an external scaling dimension, a spectral gap, and the value of the correlator at a single point.

Result: Across a wide range of conformal theories and dimensions, including both four-point and thermal two-point functions, the method has shown remarkable accuracy in reconstructing conformal correlators restricted to a line. This success is attributed to the spectral bias of gradient-based NN training, which aligns with the intrinsic smoothness property of conformal field theory.

Conclusion: The proposed method using simple neural networks trained on crossing symmetry can accurately reconstruct conformal correlators restricted to a line, demonstrating the spectral bias of gradient-based NN training aligns with an intrinsic smoothness property of conformal field theory. This suggests a novel variational principle for conformal correlators and opens a path towards a powerful new computational framework for non-perturbative quantum field theory.
...
### [52] [All-order fluctuating hydrodynamics of the SYK lattice](https://arxiv.org/abs/2604.18675)
*Marta Bucca,Akash Jain,Márk Mezei,Alexey Milekhin*

Main category: hep-th

TL;DR: We study the SYK lattice and derive hydrodynamics from its microscopic description.


<details>
  <summary>Details</summary>
Motivation: The SYK model has played an important role in recent developments in many-body quantum chaos. We study a spatially local generalisation of it: the SYK lattice.

Method: Starting from the nonlinear action of pseudo-Goldstone bosons that dominate its dynamics at low temperatures, in the long wavelength limit we reorganise this action as the effective field theory for fluctuating hydrodynamics, thereby showing how the hydrodynamic degrees of freedom embed into the microscopic description of the model. We compute the hydrodynamic effective action to high orders in the derivative expansion and determine all the corresponding transport coefficients.

Result: We compute the hydrodynamic effective action to high orders in the derivative expansion and determine all the corresponding transport coefficients.

Conclusion: This work derives hydrodynamics from the microscopic description of a strongly coupled quantum many-body system.
...
### [53] [The perturbative Ricci flow in gravity](https://arxiv.org/abs/2604.18678)
*Robert V. Harlander,Yannick Kluth,Jonas T. Kohnen,Henry Werthenbach*

Main category: hep-th

TL;DR: We formulated a perturbative Ricci flow in gravity, defined a renormalization scheme for $G_N$, and found a non-Gaußian fixed point in the renormalization group analysis.


<details>
  <summary>Details</summary>
Motivation: To develop a perturbative approach to the Ricci flow in gravity, analogous to the gradient flow in quantum chromodynamics (QCD), and to define a renormalization scheme for Newton's constant $G_N$.

Method: We supplemented the usual Feynman rules for perturbative gravity by flowed propagators and vertices as well as graviton flow lines. We calculated vacuum expectation values of independent operators at the two-loop level to derive the required counterterms of the flowed action.

Result: We derived the required counterterms of the flowed action and studied the renormalization group behavior of the Ricci-flow based renormalization scheme for $G_N$. Our results indicate the existence of a non-Gaußian fixed point.

Conclusion: We have developed a perturbative formulation of the Ricci flow in gravity, which allows us to define a Ricci-flow based renormalization scheme for Newton's constant $G_N$. By studying its renormalization group behavior, we recover a non-Gaußian fixed point.
...
### [54] [Mapping Tachyon effective field theory to a subsector of Klein-Gordon theory](https://arxiv.org/abs/2604.18679)
...
### [55] [Neural Spectral Bias and Conformal Correlators I: Introduction and Applications](https://arxiv.org/abs/2604.18686)
*Kausik Ghosh,Sidhaarth Kumar,Vasilis Niarchos,Andreas Stergiou*
...
TL;DR: This paper examines the stability of anti-de Sitter flux compactifications in ten dimensions, featuring two independent unbounded fluxes. The study reveals that close flux magnitudes lead to tachyonic modes, which can be removed by orbifold actions, while distant fluxes result in inverse scale separation. Non-perturbative instabilities, including brane nucleation, always exist and can drive the fluxes closer, potentially causing tachyonic instability.


<details>
  <summary>Details</summary>
Motivation: The motivation is to understand the complex stability dynamics of anti-de Sitter flux compactifications in the context of heterotic string theory, particularly focusing on the role of two independent unbounded fluxes. This analysis aims to uncover how these fluxes influence the perturbative and non-perturbative instabilities within the system.

Method: The method involves analyzing the stability properties of the mentioned compactifications, examining the perturbative and non-perturbative aspects of the system, and studying the effects of the two fluxes on the geometric structure and the presence of tachyonic modes.

Result: The results show that the presence of two independent unbounded fluxes leads to richer instability phenomena compared to simpler solutions. Specifically, when the fluxes are close in magnitude, tachyonic modes appear in the perturbative spectrum, which can be eliminated through an orbifold projection. When the fluxes are far apart, tachyonic modes are absent, and the geometry displays inverse scale separation. Non-perturbative instabilities, like brane nucleation, are always available and can drive the fluxes closer together, eventually triggering the tachyonic instability if present.

Conclusion: The paper investigates the stability properties of a specific family of anti-de Sitter flux compactifications in ten dimensions, focusing on the behavior of two independent unbounded fluxes. It highlights that when these fluxes are sufficiently close in magnitude, perturbative spectrum develops tachyonic modes, which can be removed by an orbifold action. Conversely, when the fluxes are far apart, tachyonic modes are absent, and the geometry exhibits inverse scale separation. Non-perturbative instabilities, such as brane nucleation, always provide decay channels and tend to drive the fluxes closer together, potentially leading to the onset of tachyonic instability.
...
### [57] [Confinement in a finite duality cascade](https://arxiv.org/abs/2604.18702)
...
### [58] [Gauging in superconductors and other electronic systems](https://arxiv.org/abs/2604.18733)
...
### [59] [Thermal Phase Structure of the Attractive Fermi Hubbard Model with Imaginary Chemical Potential](https://arxiv.org/abs/2604.18798)
*Evangelos G. Filothodoros*

Main category: hep-th

TL;DR: We investigated the BCS-BEC crossover in the large $N$ attractive Fermi-Hubbard model using mean field theory with an imaginary chemical potential. We found that the crossover is determined by three parameters and observed a thermal window at the unitarity point where the gap vanishes and the fermion number exhibits a local extremum, suggesting a change in the dominant regime between BCS and BEC physics.


<details>
  <summary>Details</summary>
Motivation: The motivation for this study is to understand the BCS-BEC crossover, which is a fundamental transition in condensed matter physics, by analyzing the behavior of the large $N$ attractive Fermi-Hubbard model under specific conditions.

Method: We employed the mean field approximation with an imaginary chemical potential to study the BCS-BEC crossover in the large $N$ attractive Fermi-Hubbard model on a one-dimensional lattice.

Result: We identified three key parameters governing the crossover: the imaginary chemical potential $iθ$, the temperature through a thermal kernel $g(βE_k,βθ)$, and the parameter $δ_u$ that controls the weak and strong coupling regimes. At the unitarity point ($U=U_c$), we observed a thermal window where the gap vanishes and the fermion number $N_f$ has a local maximum/minimum, indicating changes in the dominant regime between BCS and BEC physics.

Conclusion: Our results provide a deeper insight into the pairing correlations in lattice many-body physics, particularly at the BCS-BEC crossover point.
...
### [60] [The Hilbert Series and the Flavor Invariants of the 3HDM](https://arxiv.org/abs/2604.18895)
*Eric Bryan,Arvind Rajaraman*

Main category: hep-th

TL;DR: This paper systematically investigates invariant operators in the 3Higgs-doublet model by computing the Hilbert series and deriving explicit expressions up to cubic order in couplings.


<details>
  <summary>Details</summary>
Motivation: The motivation behind this study is to gain deeper insights into the structure of the 3Higgs-doublet model, particularly focusing on the invariant operators that are essential for describing the interactions among the Higgs fields. Understanding these invariants is vital for formulating effective field theories (EFTs) and performing high-precision calculations in particle physics.

Method: A systematic approach was employed to compute the Hilbert series and construct explicit expressions for the invariants up to cubic order in the couplings. This involved analyzing the global symmetry group of the theory and utilizing mathematical techniques such as algebraic geometry and representation theory.

Result: The results include the computation of the Hilbert series for the global symmetry group of the 3Higgs-doublet model and the derivation of explicit expressions for the invariant operators up to cubic order in the couplings. These findings contribute to a more complete theoretical description of the model and pave the way for further studies in the context of precision tests and predictions.

Conclusion: The study provides a comprehensive framework for understanding the invariant operators in the 3Higgs-doublet model, which is crucial for predicting the phenomenological outcomes of new physics scenarios involving multiple Higgs bosons.
...
### [61] [Symmetry resolved entanglement in Lifshitz field theories](https://arxiv.org/abs/2604.19082)
...
### [62] [Hamiltonian formulation for scalar and two-form gauge fields coupled to 3d gravity](https://arxiv.org/abs/2604.19109)
...
### [63] [Gauge-invariant off-shell formulations for 3D massive higher-spin supermultiplets](https://arxiv.org/abs/2604.19155)
...
### [64] [On Global Embedding of Assisted Fibre Inflation](https://arxiv.org/abs/2604.19250)
...
### [65] [The Cohomology of Solvmanifold SYZ Mirrors](https://arxiv.org/abs/2604.19303)
...
### [66] [Spatially modulated instabilities of an AdS black hole](https://arxiv.org/abs/2604.19306)
...
### [67] [On Generalized Statistics and Stability in $\mathbb{Z}_2^2$-Graded Supersymmetric Yang-Mills Theory](https://arxiv.org/abs/2604.19415)
...
### [68] [Dai-Freed anomalies and level matching in heterotic asymmetric orbifolds](https://arxiv.org/abs/2604.19634)
...
### [69] [Unitarity Quadratic Quantum Gravity in 4D](https://arxiv.org/abs/2604.19707)
*K. Sravan Kumar,João Marto*

Main category: hep-th

TL;DR: In quadratic gravity with a positive Weyl squared coefficient, the spin-2 sector is shown to correspond to a dual inverted harmonic oscillator, not a ghost. The Källén--Lehmann spectral density vanishes, leading to a unique determination of the propagator in principal value form. The theory satisfies the optical theorem and preserves unitarity and renormalizability.


<details>
  <summary>Details</summary>
Motivation: The motivation for this study is to understand the properties of the spin-2 sector in quadratic gravity, particularly focusing on whether it behaves like a ghost or a physical particle. The goal is to ensure that the theory remains consistent with unitarity and renormalizability.

Method: The method involves analyzing the quadratic gravity theory with a positive Weyl squared coefficient, using the Wightman spectrum condition to prove the vanishing of the associated Källén--Lehmann spectral density. This leads to the determination of the propagator's form and the satisfaction of the optical theorem.

Result: The result shows that the dual IHO spin-2 sector in quadratic gravity with a positive Weyl squared coefficient does not behave as a ghost but instead corresponds to a physical state. The vanishing of the Källén--Lehmann spectral density indicates the absence of a normalizable ground state and the spacelike nature of the propagator pole. This uniquely fixes the propagator to a principal value form, satisfying the optical theorem and ensuring that the theory is unitary and renormalizable.

Conclusion: The analysis confirms that in quadratic gravity with a positive Weyl squared coefficient, the spin-2 sector corresponds to a dual inverted harmonic oscillator (dual IHO) rather than a ghost. The Källén--Lehmann spectral density vanishes, indicating the absence of a normalizable ground state and the spacelike nature of the propagator pole. This uniquely determines the propagator to be in principal value form as a theorem, not a prescription. The optical theorem is satisfied, and the dual IHO spin-2 does not contribute as an asymptotic state, providing only virtual contributions at all loop orders. Consequently, unitarity is preserved consistently with renormalizability.
...
### [70] [Bootstrapping Tensor Integrals](https://arxiv.org/abs/2604.19714)
*Nathan Pagliaroli,Carlos I. Pérez-Sánchez,Brayden Smith*

Main category: hep-th

TL;DR: This paper introduces a bootstrapping method with positivity constraints to approximate the moments of $U(N)^{D}$ invariant tensor models in the large $N$ limit, demonstrating convergence to known solutions and conjecturing new formulae for the rank three quartic model.


<details>
  <summary>Details</summary>
Motivation: To study random $U(N)^{D}$ invariant tensors in the large $N$ limit, leveraging the Dyson-Schwinger equations and positivity constraints to derive approximate solutions for tensor models.

Method: A bootstrapping approach is employed, combining Dyson-Schwinger equations and positivity constraints on moments to approximate the moments of $U(N)^{D}$ invariant tensor models. Examples include the quartic and two hexic rank three tensor models.

Result: All studied models converge quickly, and for those with known analytic formulae, they converge to such solutions. Explicit formulae are conjectured for the rank three quartic model, supported by bootstrap results and double-series computations.

Conclusion: The proposed bootstrapping method with positivity constraints successfully approximates the moments of $U(N)^{D}$ invariant tensor models in the large $N$ limit, converging to known analytic solutions for some cases. New explicit formulae are conjectured for all moments of the rank three quartic model and supported by bootstrap results and double-series computations.
...
### [71] [The non-perturbative topological string: from resurgence to wall-crossing of DT invariants](https://arxiv.org/abs/2604.19731)
