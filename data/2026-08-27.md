...
### [14] [What would it take for dark matter to be literally warm?](https://arxiv.org/abs/2608.24990)
*Katelin Schutz*
...
### [15] [Enhancing dark siren cosmology via Gaussian process reconstruction of incomplete galaxy catalogs](https://arxiv.org/abs/2608.24992)
...
### [16] [Slowly Rolling on a Quantum Correction](https://arxiv.org/abs/2608.25004)
...
### [17] [Quantifying the systematic impact of differential beam response on the BICEP CMB polarization data from 2016 through 2024](https://arxiv.org/abs/2608.25016)
...
### [18] [Cosmic topology. Part Va. Information content of the observable Universe](https://arxiv.org/abs/2608.25033)
...
### [19] [The optimal redshift for dark energy I: formalism and interpretation](https://arxiv.org/abs/2608.25229)
...
### [20] [The optimal redshift for dark energy II: application to cosmological data and the evidence for the phantom crossing of the CPL equation of state](https://arxiv.org/abs/2608.25278)
...
### [21] [Distinguishing cold and self-interacting dark matter through topological analysis](https://arxiv.org/abs/2608.25632)
...
### [22] [Constraining primordial non-Gaussianity and energy injection with the thermal Sunyaev-Zeldovich effect and integrated Sachs-Wolfe effect cross-correlation](https://arxiv.org/abs/2608.25809)
...
### [23] [Filaments within filaments: unraveling the hierarchy of the cosmic web](https://arxiv.org/abs/2608.25840)
...
### [24] [Hubble tension: the shape wall](https://arxiv.org/abs/2607.21244)
...
### [26] [Probing sub-GeV dark matter through dark matter-electron scattering in the superheated $C_2H_2F_4$ target of the InDEx experiment](https://arxiv.org/abs/2608.24960)
...
### [27] [Low-Frequency Gravitational Bremsstrahlung and Memory in a Medium](https://arxiv.org/abs/2608.24994)
...
### [28] [Resonant Induced Orbital Electron Capture: Novel method for low-energy $\barν_e$ detection](https://arxiv.org/abs/2608.25001)
...
### [29] [NuGlass: A Fast and Interactive 3D Visualization of Neutrino Oscillations](https://arxiv.org/abs/2608.25049)
*Chao Zhang*
...
### [30] [Energy-independent neutrino dephasing from an ultralight axion-like background](https://arxiv.org/abs/2608.25069)
...
### [31] [Impact of local and global event conditions in prompt charm hadron ratios](https://arxiv.org/abs/2608.25086)
...
### [32] [Statistical Inference of Scattering Parameters for Exotic Hadronic States in the $J/ψ\,p$ Spectrum](https://arxiv.org/abs/2608.25106)
...
### [33] [Orbital angular momentum at small $x$ in the large $N_c\&N_f$ limit](https://arxiv.org/abs/2608.25120)
...
### [34] [Multi-messenger signal from QCD-Axion Ultracompact Minihalos](https://arxiv.org/abs/2608.25338)
...
### [35] [A Rotational Perturbative Correction to Democratic Neutrino Mixing and JUNO Compatibility](https://arxiv.org/abs/2608.25430)
...
### [36] [Particle production in $p$-O collisions at LHC energy](https://arxiv.org/abs/2608.25501)
...
### [37] [Next-to-leading power endpoint DIS and PDF factorization](https://arxiv.org/abs/2608.25502)
...
### [38] [Pair production of $h$ in the $U(1)_X$SSM](https://arxiv.org/abs/2608.25504)
...
### [39] [Rare Exclusive Top Decays t , b M and Vector-Meson Helicity](https://arxiv.org/abs/2608.25508)
...
### [40] [Quantum-Kinetic Leptogenesis and Gravitational Waves from Seesaw-Assisted Domain-Wall Dynamics](https://arxiv.org/abs/2608.25590)
*Gayatri Ghosh*
...
### [41] [A Comprehensive Analysis of the R2HDM Vacuum Evolution and the Induced GW and Collider Phenomenology](https://arxiv.org/abs/2608.25636)
...
### [42] [Impact of model-independent higher-order contributions to the Higgs-boson self-couplings](https://arxiv.org/abs/2608.25705)
...
### [43] [Odderon in the diffractive dip region](https://arxiv.org/abs/2608.25713)
...
### [44] [Low-$x$ parton densities accounting for absorptive effects and exclusive $J/ψ$ and $Υ$ data from the LHC](https://arxiv.org/abs/2608.25724)
...
### [45] [Deeply Inelastic Scattering Revisited](https://arxiv.org/abs/2608.25790)
*Felix Hekhorn*
...
### [46] [Imaginary Rotation Breaks Charge Conjugation in Hot QCD](https://arxiv.org/abs/2608.25849)
*Rin Takada*
...
### [47] [How elastic unitarity governs resonance peaks and residue phases](https://arxiv.org/abs/2608.25802)
...
### [48] [Robust Finite-Momentum Instabilities in Dense Matter](https://arxiv.org/abs/2608.25857)
...
### [49] [Mixing effects in radiative decays of heavy-strange axial-vector mesons within light-cone QCD sum rules](https://arxiv.org/abs/2608.25843)
...
### [50] [Jet Quenching Meets Gluon Saturation](https://arxiv.org/abs/2608.25983)
...
### [51] [Color Coherence and the Soft Structure of QCD Jets in Vacuum and the QGP](https://arxiv.org/abs/2608.25984)
...
### [52] [Strong CP and the PMNS Phase in Dirac Left-Right Symmetry](https://arxiv.org/abs/2608.26063)
*Vladimir Tello*
...
### [53] [Emergence of Kastor-Traschen spacetime from a nonlinear Dirac system](https://arxiv.org/abs/2608.24975)
*Daisuke Ida*
...
### [54] [Anti-Ultralocality and Plateau Models of Inflation](https://arxiv.org/abs/2608.24997)
...
### [55] [Exact Integrable $Λ$CDM-Mimicking $f(Q)$ Cosmology: Background, Stability, and Perturbations in the First Connection Branch](https://arxiv.org/abs/2608.25025)
...
### [56] [21-cm Brightness Temperature in a Unified-Dark-Sector Horndeski Theory](https://arxiv.org/abs/2608.25159)
...
### [57] [The relationship between spacetime singularities and regions at infinity](https://arxiv.org/abs/2608.25317)
...
### [58] [A 3D Summation-by-Parts scheme on a Hyperboloidal Foliation of Minkowski](https://arxiv.org/abs/2608.25363)
*Shalabh Gautam*
...
### [59] [A Generalized Class of Taub-NUT-Scalar Metrics](https://arxiv.org/abs/2608.25368)
...
### [60] [Stationary Dirac condensates around Kerr black holes](https://arxiv.org/abs/2608.25436)
...
### [61] [Pair creation in weak gravity and gauge backgrounds: spinning fields and binary stars](https://arxiv.org/abs/2608.25540)
...
### [62] [Two-branch detector response for Dirac infall into a Schwarzschild--MOG black hole](https://arxiv.org/abs/2608.25566)
...
### [63] [Reconstructing $f(R)$ gravity from generalized entropies: exact Lagrangians](https://arxiv.org/abs/2608.25722)
...
### [64] [Vacuum energy problem in anti-de Sitter space](https://arxiv.org/abs/2608.25860)
...
### [65] [Defining higher memory signals and forecasting their observation prospects for binary-black-hole mergers with next-generation gravitational-wave detectors](https://arxiv.org/abs/2608.23739)
...
### [66] [Mode stability for the scalar wave equation on subextremal Kerr-de Sitter spacetimes](https://arxiv.org/abs/2608.25868)
*Peter Hintz*
...
### [67] [Atmospheric Newtonian noise in torsion-balance measurements of the gravitational constant $G$](https://arxiv.org/abs/2608.26020)
...
### [68] [Torsion balances as operational probes of semiclassical gravity: Matched-filter bounds, torque-diffusion constraints, and quantum-noise benchmarks](https://arxiv.org/abs/2608.26096)
*Jyotirmaya Mohanta,Yutaka Shikano*
