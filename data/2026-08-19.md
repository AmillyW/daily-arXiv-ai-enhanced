...
### [1] [Revisiting In-Medium QCD Effects on Spin-Polarized Strange Quark Stars](https://arxiv.org/abs/2608.15355)
...
### [2] [Exploring charmonia $η_c(6S,7S)$ in the $Λ_c^+\barΛ_c^-$ invariant mass spectrum of $B^0 \to K_S^0Λ_c^+\barΛ_c^-$](https://arxiv.org/abs/2608.15524)
...
### [3] [Probing the ALP--Photon--Dark Photon Interaction through the Mono-Photon plus Missing-Energy Signature at a Muon Collider](https://arxiv.org/abs/2608.15656)
...
### [4] [Probing 5.49 MeV Solar Axions at Xenon Experiments](https://arxiv.org/abs/2608.15699)
...
### [5] [Estimation of the cumulant $b_4$ and sextic self-coupling of the QCD axion at finite temperature and density](https://arxiv.org/abs/2608.15855)
...
### [6] [Universality and Kinematic Dependence of Hadronization Effects in DIS Global Event Shapes](https://arxiv.org/abs/2608.15898)
...
### [7] [Photon Fragmentation Functions in LHAPDF: Existing Sets and a Pythia-Based Extraction](https://arxiv.org/abs/2608.15944)
...
### [8] [Functional anatomy of Pythia-Herwig differences with Kolmogorov-Arnold networks](https://arxiv.org/abs/2608.15952)
...
### [9] [Probing T and CP Violation at DUNE and T2HK](https://arxiv.org/abs/2608.15960)
...
### [10] [Assessing Parameter Redundancy in Transformers for Jet Tagging](https://arxiv.org/abs/2608.16061)
...
### [11] [Unfolding the low-energy reactor neutrino flux from CE$ν$NS data with a finite Dirac sum](https://arxiv.org/abs/2608.16107)
...
### [12] [Extending the Constituent Gluon Model to Heavy-Flavour Hybrids: A Unified Study of $c\bar{c}g$ Mesons](https://arxiv.org/abs/2608.16250)
...
### [13] [Amplified Isospin Breaking from Coupled-Channel Dynamics Near Threshold](https://arxiv.org/abs/2608.16266)
...
### [14] [Cosmological Signatures of the Conformal and Non-Conformal Next-to-Minimal Two-Higgs-Doublet Model](https://arxiv.org/abs/2608.16399)
...
### [15] [Rotation modified QCD equation of state across crossover at finite chemical potential](https://arxiv.org/abs/2608.16478)
...
### [16] [Two-loop tensor integral reduction for automated tools](https://arxiv.org/abs/2608.16744)
...
### [17] [Exotics with gluonic excitations](https://arxiv.org/abs/2608.16784)
*Jozef J. Dudek*
...
### [18] [Truncation of the Radial Ladder in Heavy Quarkonia](https://arxiv.org/abs/2608.16875)
...
### [19] [First Order Phase Transition Induced Graviton Bremsstrahlung: A Multi Peak Gravitational Wave Signature](https://arxiv.org/abs/2608.14782)
...
### [20] [Leading order quark-antiquark-W-boson vertex in the presence of a magnetic field](https://arxiv.org/abs/2608.14890)
...
### [21] [Uncovering Hidden Leptonic Correlations with Flow Matching and Autoencoders](https://arxiv.org/abs/2608.15042)
...
### [22] [Five-Dimensional Traversable Wormholes in Einstein-Gauss-Bonnet Gravity with a Cloud of Strings](https://arxiv.org/abs/2608.15049)
...
### [23] [Impact of a Cold Dark Matter Halo on Magnetic Reconnection and Energy Extraction from Kerr-like Black Holes](https://arxiv.org/abs/2608.15123)
...
### [24] [Magnetic Reconnection and Energy Extraction from a Rotating Black Hole in the Einstein-AdS SU(N)-Nonlinear Sigma Model](https://arxiv.org/abs/2608.15128)
...
### [25] [Energy Extraction via Magnetic Reconnection from Rotating ModMax Black Holes](https://arxiv.org/abs/2608.15132)
...
### [26] [Static Magnetic Brane Solutions in Quartic Quasi-Topological Gravity with Power-Law Maxwell Nonlinear Electrodynamics](https://arxiv.org/abs/2608.15178)
...
### [27] [Fluid interpretation, Hawking--Ellis classification, and energy conditions of the proper kinetic gravity braiding stress tensor](https://arxiv.org/abs/2608.15228)
...
### [28] [Study of gravitational radiation at $\mathscr{J}$ for the general type-D Einstein-Maxwell solution with cosmological constant](https://arxiv.org/abs/2608.15280)
...
### [29] [Extremal non-rotating black holes have no fermionic Love](https://arxiv.org/abs/2608.15479)
...
### [30] [Observational Signatures of Thin Accretion Disks around Rotating Black Holes Embedded in Dark Matter Halos](https://arxiv.org/abs/2608.15487)
...
### [31] [Nonlinear Density Waves and a Galactic-Scale Estimate of the Graviton Mass](https://arxiv.org/abs/2608.15581)
*Miroslava Vukcevic*
...
### [32] [Gravitational Aharonov-Bohm effect: theory and experiment](https://arxiv.org/abs/2608.15587)
...
### [33] [Temperature encoding rates of two-level probes in de Sitter spacetime](https://arxiv.org/abs/2608.15607)
*Yao Jin*
...
### [34] [Light deflection in the gravitational field of a solar system body with finite distance of source and observer for sub-micro-arcsecond astrometry](https://arxiv.org/abs/2608.15658)
*Sven Zschocke*
...
### [35] [Effective metric for bound state in an effective-one-body theory based on the third-post-Minkowskian approximation](https://arxiv.org/abs/2608.15723)
...
### [36] [Characteristic evolution of conformal scattering: I. Scalar Waves in Minkowski Spacetime](https://arxiv.org/abs/2608.15729)
...
### [37] [Horizon singularity, energy conditions and shadows in time-dependent and spherically symmetric spacetime](https://arxiv.org/abs/2608.15740)
...
### [38] [Hawking Radiation and Second-Order Quantum Corrected Thermodynamics with Black Hole Remnant Formation in a Vaidya-Bonnor Black Hole Surrounded by Quintessence](https://arxiv.org/abs/2608.15791)
...
### [39] [Constraint on environments with eccentric extreme-mass-ratio inspirals: Bayesian inference and Fisher-matrix for dark-matter spikes](https://arxiv.org/abs/2608.15985)
...
### [40] [Perturbative solutions for the bumblebee field in a Schwarzschild background](https://arxiv.org/abs/2608.15988)
...
### [41] [Dark Matter Admixed Quark Stars: A Relativistic Two-Fluid Approach](https://arxiv.org/abs/2608.16064)
...
### [42] [Exceptional points of the Schwarzschild spectrum under local potential perturbation: The Princess and the Pea](https://arxiv.org/abs/2608.16283)
...
### [43] [Revisiting environmental effects on black hole quasibound-state spectra with relativistic perturbation theory](https://arxiv.org/abs/2608.14971)
...
### [44] [Charge-Induced Pole Cancellation and Horizon Transitions in Scale-Dependent Gravitational Collapse](https://arxiv.org/abs/2608.16341)
...
### [45] [Limiting cases of second-order moments of relativistic stars and their universality](https://arxiv.org/abs/2608.16376)
*Koutarou Kyutoku*
...
### [46] [Exceptional lines of Reissner-Nordström-de Sitter black hole surrounded by a thin shell of matter](https://arxiv.org/abs/2608.16521)
...
### [47] [Quasinormal Modes of Black Holes Embedded in Dark-Matter Halos: Analysis of Dehnen(1, 4, 5/2) and DC14 Density Profiles](https://arxiv.org/abs/2608.16525)
*Gaurav Rachh*
...
### [48] [Quasi-local Hamiltonian for generalized Kerr-Schild black holes in the Iyer-Wald formalism](https://arxiv.org/abs/2608.16534)
...
### [49] [Riesz--Laurent representation of black-hole scattering and sourced response at exceptional points](https://arxiv.org/abs/2608.14752)
...
### [50] [Non-exotic traversable wormholes in Einstein-Chern-Simons gravity](https://arxiv.org/abs/2608.16723)
...
### [51] [On the (Non)Unitarity with respect to the Clock of a Dynamical Local Observer and the Einstein Equivalence Principle](https://arxiv.org/abs/2608.16762)
*Kengo Shimada*
...
### [52] [New metric useful for studies of gravitational radiation from accelerating black holes of type D with any cosmological constant](https://arxiv.org/abs/2608.14919)
*Jiri Podolsky*
...
### [53] [On M2-, M5-, and D3-branes from 12d anomalies: an equivariant perspective on duality](https://arxiv.org/abs/2608.14932)
...
### [54] [History-Dependent Mode Selection in a Driven Holographic Superfluid](https://arxiv.org/abs/2608.14997)
*Bo-Xuan Ge*
...
### [55] [Spinning Conformal Correlators from Neural Networks](https://arxiv.org/abs/2608.15001)
...
### [56] [Quasinormal frequencies and greybody factors for axial perturbations of dilaton-Euler-Heisenberg de Sitter black holes](https://arxiv.org/abs/2608.15111)
...
### [57] [Topological Field Theory and Stochastic Dynamics](https://arxiv.org/abs/2608.15220)
*Igor V. Ovchinnikov*
...
### [59] [Quantum Information in SYK Model](https://arxiv.org/abs/2608.15589)
...
### [60] [Catastrophic Inflation in the Axiverse](https://arxiv.org/abs/2608.14780)
...
### [61] [Positive Singularities and Volumes in Scattering Amplitudes](https://arxiv.org/abs/2608.15606)
*Elia Mazzucchelli*
...
### [62] [The linear dilaton in cosmology and particle physics](https://arxiv.org/abs/2608.16772)
...
### [63] [Strong CP Problem in Type IIA Toroidal Orientifold String Theory](https://arxiv.org/abs/2608.15611)
*Yang Liu*
...
### [64] [Bezoutian Decoupling for Conformal Yang--Mills Multiplets in $(A)dS$](https://arxiv.org/abs/2608.15628)
*Weiqi Jiang*
...
### [65] [Renormalization-group locking of finite anisotropic propagation cones in Yukawa networks](https://arxiv.org/abs/2608.15661)
*Shuai Zeng*
...
### [66] [Bootstrapping bilinear relations of discrete Painlevé systems from 5d gauge theories](https://arxiv.org/abs/2608.15756)
...
### [74] [Flat space limits of symmetric Taub-NUT instantons](https://arxiv.org/abs/2608.16487)
*Matthew Dales*
...
### [76] [Metric Reconstruction from Timelike Entanglement Entropy](https://arxiv.org/abs/2608.16517)
...
### [77] [7-branes and $Γ_0(2)$ Duality in Type 0B String Theory](https://arxiv.org/abs/2608.16522)
...
### [78] [Chiral Soliton Lattices under Magnetic Fields and Rotation: a Holographic Analysis](https://arxiv.org/abs/2608.16579)
...
### [79] [Higher spin dynamics in Weyl reference frame](https://arxiv.org/abs/2608.16781)
...
### [80] [MacDowell-Mansouri $σ$-model](https://arxiv.org/abs/2608.14596)
...
### [81] [Modelling the nonlinear matter power spectrum in Hu-Sawicki $f(R)$ gravity with the Web-Halo Model](https://arxiv.org/abs/2608.15635)
...
### [82] [Testing Matter Diffusion with Late-Time Cosmological Observations](https://arxiv.org/abs/2608.15950)
...
### [83] [Cosmology without the cosmological principle: A study of the large-scale structure effects in the background universe](https://arxiv.org/abs/2608.15983)
*Erick Pastén*
...
### [84] [Brightest group and cluster galaxies as indicators of relaxation](https://arxiv.org/abs/2608.16481)
...
### [85] [Nonlinear velocity power spectrum: modeling the cosmological dependence on the Hubble constant and cold dark matter density](https://arxiv.org/abs/2608.16489)
...
### [86] [Halo Mass of ULIRGs at Cosmic Noon](https://arxiv.org/abs/2608.16667)
...
### [87] [Prospects for Direct Detection of Ultralight Dark Matter candidates in deci-Hz Band with IndIGO-D](https://arxiv.org/abs/2608.15240)
...
### [88] [Addressing position anomalies in the Strong Gravitational Lensing System HS~0810+2554 through Dark Matter Subhalos](https://arxiv.org/abs/2608.15554)
...
### [89] [Testing a Sign-Switch Cosmological Model with Curvature through Latest Planck 2018, DESI DR2 and PantheonPlus\&SH0ES Observational Data](https://arxiv.org/abs/2608.15167)
...
### [90] [Redshift dependence and dipolar velocity corrections in cosmographic reconstructions through Type Ia supernova samples](https://arxiv.org/abs/2608.15858)
