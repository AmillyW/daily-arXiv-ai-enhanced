...
### [1] [The Good, the Bad, and the Subtle: Relativistic mode sums for neutron-star tidal response](https://arxiv.org/abs/2605.08569)
...
### [2] [General Grad-Shafranov Equation](https://arxiv.org/abs/2605.08597)
*Ye Shen*
...
### [3] [Gravitational waveform from radial infall at the third-and-half Post-Newtonian order](https://arxiv.org/abs/2605.08798)
...
### [4] [Matter Maps to Geometry in Gravitational Collapse](https://arxiv.org/abs/2605.08807)
...
### [5] [Late-Time Cosmic Acceleration in Ricci-Gauss-Bonnet Gravity via Gradient Descent Optimization](https://arxiv.org/abs/2605.08893)
...
### [6] [Neutron stars in a conservative $f(R,T)$ gravity](https://arxiv.org/abs/2605.09206)
...
### [7] [Efficient and Stable Computation of Gravitational-Wave Fluxes from Generic Kerr Orbits via a Unified HeunC Framework](https://arxiv.org/abs/2605.09250)
...
### [8] [Resonant transmission of scalar waves through rotating traversable wormhole](https://arxiv.org/abs/2605.09426)
...
### [9] [Multimessenger consistency tests of the Friedmann cosmological model](https://arxiv.org/abs/2605.09660)
*Antonio Enea Romano*
...
### [10] [Hawking Radiation and Greybody Factors of Test Scalar and Electromagnetic Fields on Asymptotically Flat Pure Lovelock Black Holes](https://arxiv.org/abs/2605.09756)
*Jayden Tan*
...
### [11] [Quantum Maxwell Demon at the Black Hole Horizon: Thermodynamics, Information, and the Equivalence Principle](https://arxiv.org/abs/2605.09783)
...
### [12] [Gravielectric and gravimagnetic fluxes in nutty black holes](https://arxiv.org/abs/2605.09786)
...
### [13] [Regular hairy black holes by gravitational decoupling: Bardeen and Minkowski-core seeds](https://arxiv.org/abs/2605.09941)
*Daulet Berkimbayev*
...
### [14] [A study on Dusty Plasma Physics and the examination of Jeans Criteria for the Milky Way](https://arxiv.org/abs/2605.09943)
...
### [15] [Analytical solution of traversable wormholes in the presence of positive cosmological constant](https://arxiv.org/abs/2605.08205)
...
### [16] [BB plot: A Tool for Accurate Model Selection Using Bayes factors](https://arxiv.org/abs/2605.10333)
*Ankur Barsode*
...
### [23] [Entanglement Requirements for Coherent Enhancement in Detectors](https://arxiv.org/abs/2605.08337)
...
### [24] [Electroweak Restoration: SMEFT and HEFT](https://arxiv.org/abs/2605.08433)
...
### [25] [Lepton Flavor Violating Higgs decays at the Compact Linear Collider](https://arxiv.org/abs/2605.08501)
...
### [26] [Scaling properties of net-baryon number fluctuations at the deconfinement critical point](https://arxiv.org/abs/2605.08543)
...
### [27] [Higher-order local constraints from reciprocal symmetry and entanglement entropy of charged-particle multiplicity distributions in $pp$ collisions](https://arxiv.org/abs/2605.08736)
...
### [28] [$B$ anomalies and the tauphilic leptoquark model](https://arxiv.org/abs/2605.08861)
*Jong-Phil Lee*
...
### [29] [F-Term Hybrid Inflation with T-Model Kähler Geometry and Beyond](https://arxiv.org/abs/2605.08931)
...
### [30] [Direct determination of the structure functions $F_L$, $F_S$ and $G$ from $F_2$ and $dF_2/dQ^2$ to $O(α_s^2)$](https://arxiv.org/abs/2605.08940)
...
### [31] [Optimizing Yukawa couplings to suppress Dimension-five Proton Decay in $SU(5)$ GUT](https://arxiv.org/abs/2605.09000)
...
### [32] [Inferring identified hadron production in $pp$ collisions with physics-informed machine learning at the LHC](https://arxiv.org/abs/2605.09022)
...
### [33] [Can a Nonstandard Invisible Pair Mimic the Michel Distribution?](https://arxiv.org/abs/2605.09140)
*Pablo Roig*
...
### [34] [Ortho-Positronium Three-Photon Decays: Physics Constraints and a Closed-Form Energy Method for Annihilation Vertex Reconstruction](https://arxiv.org/abs/2605.09174)
...
### [35] [Probing the nature of $D_1 K$ and $D_2 K$ molecules through $D_s^{(*)}ππ$ and $D_{s0(s1)}π$ decays](https://arxiv.org/abs/2605.09381)
...
### [36] [Primordial Black Hole Hotspots Beyond Flat Spacetime](https://arxiv.org/abs/2605.08336)
...
### [37] [Non-factorisable electroweak virtual corrections to single-resonant processes](https://arxiv.org/abs/2605.09444)
...
### [38] [Asymmetric Reheating of Dark QED](https://arxiv.org/abs/2605.09686)
...
### [39] [An Algorithm for the Symbolic Reduction of Multi-loop Feynman Integrals via Generating Functions](https://arxiv.org/abs/2605.09541)
...
### [40] [Controlled Penumbral Inflation from Monodromic Valleys](https://arxiv.org/abs/2605.10197)
*Pirzada,Tianjun Li*
...
### [42] [Spin-flavor entanglement in $Λ_b \to ΛD$ and weak phase extraction](https://arxiv.org/abs/2605.09682)
...
### [43] [Chiral Structure and Selection Rules in Light-Front Nucleon-Pentaquark Mixing](https://arxiv.org/abs/2605.09840)
...
### [44] [Dissecting Jet-Tagger Through Mechanistic Interpretability](https://arxiv.org/abs/2605.09881)
...
### [45] [MSSM flavors from 7-brane configurations of magnetized SYM on $R^{1,3} \times (T^2)^3/(Z_2 \times Z'_2)$](https://arxiv.org/abs/2605.09940)
...
### [46] [Higgs-Portal Spin-1 Dark Matter with Parity-Violating Interaction for a Galactic Halo Gamma Ray Excess](https://arxiv.org/abs/2605.09979)
*Kimiko Yamashita*
...
### [47] [EEXICC: An event generator for doubly heavy baryon production at $e^+e^-$ colliders](https://arxiv.org/abs/2605.10460)
...
### [48] [Axial Quasi-normal Modes of Admixed Neutron Stars](https://arxiv.org/abs/2605.10467)
...
### [49] [Study of $η^\prime \to ηππ$ Decays in Large-$N_C$ Chiral Perturbation Theory](https://arxiv.org/abs/2605.10619)
...
### [50] [Heavy-Quark Condensate and Vacuum Energy Anomalous Dimension at Five Loops](https://arxiv.org/abs/2605.10635)
...
### [51] [The X17 Existence Hinted at by Nuclear Reactor Neutrinos](https://arxiv.org/abs/2605.10689)
...
### [52] [Distinguishing Higgs portal and neutralino dark matter via vector boson fusion](https://arxiv.org/abs/2605.10699)
...
### [53] [Bogomol'nyi Equations in Mixed Product Chern-Simons Theories Governing Charged Vortices and Antivortices](https://arxiv.org/abs/2605.08822)
*Aonan Xu*
...
### [54] [Non-Abelian monopoles in modified gravity](https://arxiv.org/abs/2605.09612)
...
### [55] [Taming the infrared in de Sitter space: autonomous equations, stochastic approach, and Borel resummation](https://arxiv.org/abs/2605.09736)
...
### [56] [Joint distributions of eigenvectors of symmetric random tensors](https://arxiv.org/abs/2605.09804)
*Naoki Sasakura*
...
### [57] [Double fibration in G-theory and the cobordism conjecture](https://arxiv.org/abs/2605.09868)
...
### [58] [The Free Particle--Oscillator--Inverted Oscillator Triangle: Conformal Bridges, Metaplectic Rotations and $\mathfrak{osp}(1|2)$ Structure](https://arxiv.org/abs/2605.09947)
...
### [59] [Bulk-Edge Correspondence via Higher Gauge Theory](https://arxiv.org/abs/2605.10232)
...
### [60] [Infrared spectra of some strongly--coupled chiral gauge theories](https://arxiv.org/abs/2605.10416)
...
### [61] [Birth of Inflationary Universes via Wineglass Wormholes and their No-Boundary Relatives](https://arxiv.org/abs/2605.10548)
...
### [62] [On the Casimir effect with mixed dynamical edge mode and perfect electromagnetic conducting boundary conditions](https://arxiv.org/abs/2605.10662)
...
### [63] [Regularized Master-Field Approximation for Large-$N$ Reduced Matrix Models](https://arxiv.org/abs/2605.10720)
*Reishi Maeta*
...
### [64] [Axion-Scalar Dynamics: from the Distance Conjecture to Cosmic Acceleration](https://arxiv.org/abs/2605.10735)
*Filippo Revello*
...
### [65] [Krylov state complexity for BMN matrix model](https://arxiv.org/abs/2605.10786)
...
### [66] [Parafermionizing the Monster](https://arxiv.org/abs/2605.10902)
...
### [67] [Reionisation time field reconstruction from 21-cm Maps: Investigating predictor coherence in WDM cosmology](https://arxiv.org/abs/2605.08970)
...
### [68] [Challenges to the cosmological constant model following results from the Dark Energy Survey](https://arxiv.org/abs/2605.09560)
...
### [69] [Einstein-Cartan pseudoscalaron inflation, reheating and nonthermal leptogenesis](https://arxiv.org/abs/2605.09571)
...
### [70] [On the residual missing mass of the Bullet Cluster](https://arxiv.org/abs/2605.10022)
*Benoit Famaey*
...
### [71] [Application of Machine Learning to 21 cm Cosmology](https://arxiv.org/abs/2605.10105)
*Hayato Shimabukuro*
...
### [72] [Reionization History and Neutrino Mass](https://arxiv.org/abs/2605.10116)
...
### [73] [STEPSIC: Initial condition generator for stereographic cosmological simulations](https://arxiv.org/abs/2605.10354)
...
### [74] [Breaking Free from the Swampland of Impossible Universes through the DESI Portal](https://arxiv.org/abs/2605.10476)
...
### [75] [Multifield stochastic inflation: Relevance of number of fields in statistical moments](https://arxiv.org/abs/2605.10656)
...
### [76] [Machine Learning Techniques for Astrophysics and Cosmology: Simulation-Based Inference](https://arxiv.org/abs/2605.10719)
*Leander Thiele*
...
### [77] [Numerical Study of Some Generalizations of the Starobinsky Inflationary Model](https://arxiv.org/abs/2605.10728)
...
### [78] [Mitigating residual foregrounds and systematic errors in SKA1-Low AA* EoR observations via Bayesian Gaussian Process Regression](https://arxiv.org/abs/2605.10928)
...
### [79] [Demonstrating the Use of the Spherical Fourier Bessel Basis for Large Scale Clustering Systematics Discovery and Mitigation with eBOSS](https://arxiv.org/abs/2605.10935)
