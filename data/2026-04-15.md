...
TL;DR: Transverse polarization of electron-positron beams increases quantum entanglement in various processes, making it a valuable tool for quantum information studies at high-energy colliders.


<details>
  <summary>Details</summary>
Motivation: To investigate the role of transverse polarization in enhancing quantum entanglement in different particle interactions, which could lead to advancements in quantum information science at high-energy physics experiments.

Method: Systematic study of spin correlations and quantum entanglement in transversely polarized electron-positron collisions using theoretical analysis and possibly numerical simulations.

Result: It was found that transverse polarization leads to maximally entangled states in the $s$-channel QED process and enhances entanglement in electroweak processes as well. The sensitivity of final spin states to transverse polarization suggests its utility in collider experiments for quantum entanglement generation and control.

Conclusion: The transverse polarization of electron-positron beams significantly enhances the entanglement in various quantum processes, including QED and electroweak interactions. This makes beam polarization a powerful tool for generating and controlling quantum entanglement in collider experiments, offering new opportunities for quantum information studies at high-energy colliders.
...
TL;DR: Energy correlators in QCD reveal universal anomalous scaling in linear corrections, which is explained by a quantum field-theoretic structure. An explicit loop calculation derived the one-loop anomalous dimension, linking operator theory with collider physics.


<details>
  <summary>Details</summary>
Motivation: Energy correlators are used as a clean probe of QCD, providing an ideal laboratory for investigating non-perturbative power corrections. The recent discovery of universal anomalous scaling in linear corrections suggests a deep theoretical structure that needs to be understood.

Method: The method involves using light-ray operators to uncover the quantum field-theoretic origin of the universal anomalous scaling observed in energy-energy correlators. An explicit loop calculation was performed to derive the one-loop anomalous dimension, showing that the dijet operator must be combined with a specific triple-jet component.

Result: The result is the derivation of the one-loop anomalous dimension through an explicit loop calculation, which shows that the dijet operator must be combined with a specific triple-jet component. This provides a first-principles framework connecting operator theory with high-precision collider phenomenology.

Conclusion: The analysis of energy correlators in quantum chromodynamics (QCD) reveals a universal anomalous scaling in linear corrections, which is attributed to the quantum field-theoretic structure. This leads to a first-principles framework that links operator theory with high-precision collider phenomenology.
...
TL;DR: The paper presents a simplified model showing how baryon asymmetry and dark matter can be generated simultaneously by the decay of a WIMP-like particle, produced non-thermally during an early Matter domination epoch. This resolves the standard model's inability to produce enough baryon asymmetry and demonstrates a common origin for both phenomena, with particle masses in the collider-detectable range.


<details>
  <summary>Details</summary>
Motivation: The motivation behind the paper is to explain the simultaneous generation of baryon asymmetry and dark matter in the context of a simplified model. The standard cosmological model struggles to produce enough baryon asymmetry, so the authors aim to resolve this issue by proposing a non-standard scenario involving a matter-dominated phase and a non-thermally produced dark matter candidate. This approach allows for a common origin of these two fundamental components of the universe.

Method: The authors use a simplified model to illustrate their scenario. They first consider the standard evolution of the Universe and introduce TeV-scale Beyond Standard Model (BSM) particles. They find that this paradigm cannot produce sufficient baryon asymmetry. To address this, they propose a non-standard scenario involving a matter-dominated phase before radiation domination and include a non-thermally produced dark matter candidate. Their results demonstrate a common origin for baryon asymmetry and dark matter, with particle masses in the collider-detectable range due to the non-standard early Universe evolution.

Result: The results show that the proposed scenario can generate both baryon asymmetry and dark matter from the decay of a WIMP-like mother particle, which is produced non-thermally during an early epoch of Matter domination. This addresses the deficiency in the standard model's ability to produce sufficient baryon asymmetry. The inclusion of a matter-dominated phase and a non-thermally produced dark matter candidate leads to a common origin for both phenomena, with particle masses within the collider-detectable range.

Conclusion: The paper proposes a scenario where the baryon asymmetry and dark matter are simultaneously generated by the decay of a WIMP-like mother particle, which is produced non-thermally during an early epoch of Matter domination. This resolves the deficiency in producing enough baryon asymmetry found in the standard cosmological model. The presence of a matter-dominated phase prior to radiation-domination and a non-thermally produced dark matter candidate leads to a common origin for both phenomena, with particle masses within the collider-detectable range.
...
TL;DR: We present a model with $\mathrm{SU}(3)_C \times \mathrm{SU}(3}_L \times \mathrm{U}(1)_N$ and right-handed neutrinos that generates a sub-MeV dark matter candidate as a pseudo-Goldstone boson, acquiring mass via gravitational effects. The observed relic abundance is achieved through freeze-in in a low-reheating temperature scenario, without requiring tiny couplings. The model is testable at the TeV scale and with future collider experiments.


<details>
  <summary>Details</summary>
Motivation: The motivation is to develop a model that can naturally accommodate a sub-MeV dark matter candidate, which is consistent with observations and can be tested experimentally. The model should avoid requiring tiny couplings and operate within a TeV scale framework.

Method: The method involves constructing a model with $\mathrm{SU}(3)_C \times \mathrm{SU}(3}_L \times \mathrm{U}(1)_N$ symmetry and incorporating right-handed neutrinos to generate a pseudo-Goldstone boson that serves as a viable dark matter candidate. The mass of this boson is generated by gravitational effects. The freeze-in mechanism is utilized to obtain the observed relic abundance under a low-reheating temperature scenario, avoiding the need for tiny couplings. The model is tested at the TeV scale and can be probed at current and future collider experiments.

Result: The result is the successful construction of a model with $\mathrm{SU}(3)_C \times \mathrm{SU}(3}_L \times \mathrm{U}(1)_N$ symmetry and right-handed neutrinos, which produces a pseudo-Goldstone boson as a dark matter candidate. This boson acquires a tiny mass due to gravitational effects. The observed relic abundance is obtained through the freeze-in process in a low-reheating temperature environment, without necessitating tiny couplings. The model is operational at the TeV scale and is within reach of current and future collider experiments.

Conclusion: The model with $\mathrm{SU}(3)_C \times \mathrm{SU}(3}_L \times \mathrm{U}(1)_N$ and right-handed neutrinos naturally provides a sub-MeV dark matter candidate as a pseudo-Goldstone boson, which acquires mass through gravitational effects. The observed relic abundance is achieved via freeze-in in a low-reheating temperature scenario, without needing tiny couplings. The model operates at the TeV scale and is testable at current and future collider experiments.
...
TL;DR: This paper investigates the neutrinoless double-beta decay process involving $Δ$ resonances using chiral effective field theory, predicting the pion-mass dependence of the decay amplitude and facilitating lattice-QCD matching.


<details>
  <summary>Details</summary>
Motivation: The motivation is to understand the role of intermediate $Δ$ resonances in enhancing the neutrinoless double-beta decay process, which is crucial for interpreting nuclear neutrinoless double-beta decay experiments.

Method: The method involves using chiral effective field theory to derive long-range contributions from light-Majorana-neutrino exchange through loop diagrams and incorporating short-range parts through renormalization counterterms. The calculations are performed in both the kinematic configuration with collinear electrons and the degenerate $Δ$-nucleon mass limit.

Result: The results include predictions for the pion-mass dependence of the decay amplitude in the kinematic configuration with collinear electrons and the corresponding long-range prediction in the degenerate $Δ$-nucleon mass limit, which aids in lattice-QCD matching.

Conclusion: The study provides a systematic approach to describing the neutrinoless double-beta decay process involving $Δ$ resonances, predicting the pion-mass dependence of the decay amplitude and facilitating lattice-QCD matching.
...
TL;DR: The paper develops $	ext{N}^3$LO predictions for photon production in high-energy hadron collisions, demonstrating perturbative convergence and addressing computational challenges. The findings are relevant for the Large Hadron Collider.


<details>
  <summary>Details</summary>
Motivation: The motivation is to improve the understanding of high-energy hadron collisions by providing more accurate predictions at higher orders of perturbation theory. This is crucial for validating the theoretical framework and for precise experimental interpretations at the Large Hadron Collider.

Method: The authors employ advanced theoretical methods to derive $	ext{N}^3$LO predictions, addressing large corrections through NNLO. They utilize sophisticated computational techniques to handle the complexity of the calculations.

Result: The paper achieves $	ext{N}^3$LO predictions for the production of two isolated photons, which show perturbative convergence. The results are significant for the Large Hadron Collider, as they provide a more reliable basis for interpreting experimental data.

Conclusion: The paper presents novel $	ext{N}^3$LO predictions for the production of two isolated photons in high-energy hadron collisions and demonstrates perturbative convergence for this process. The computational challenges are discussed, and phenomenological results for the Large Hadron Collider are presented.
...
TL;DR: The abstract discusses the challenge of linking quantum and classical descriptions in relativistic heavy-ion collisions. It proposes using the Wehrl-like entropy to coarse-grain the proton's phase-space distribution, enabling a consistent characterization of entropy deposition in small collision systems.


<details>
  <summary>Details</summary>
Motivation: The motivation arises from the need to properly characterize the initial state for hydrodynamic evolution in relativistic heavy-ion collisions, where the microscopic description of protons is quantum but the macroscopic description requires an entropy current corresponding to a maximally mixed state.

Method: The method involves coarse-graining the phase-space distribution of the proton wave function using the Wehrl-like entropy to bridge the gap between quantum and classical descriptions in hydrodynamic evolution.

Result: The result demonstrates that the Wehrl-like entropy, when applied to the phase-space distribution of the proton wave function, allows for a consistent matching between the quantum nature of the proton and the classical hydrodynamics, thereby providing a suitable framework for characterizing entropy deposition in small collision systems.

Conclusion: The Wehrl-like entropy provides a semi-classical, positive-definite measure of the density of accessible microstates at a given resolution scale, and is thus the appropriate quantity to characterize entropy deposition in small collision systems.
...
TL;DR: This paper investigates the properties of glueballs, composite particles made of gluons, to understand how the strong interaction creates mass through the interaction of color charges.


<details>
  <summary>Details</summary>
Motivation: To explore the fundamental aspects of the strong interaction by examining the properties and dynamics of glueballs, which are composed of multiple gluons and exhibit mass due to the interaction of color charges.

Method: Theoretical analysis and conceptual modeling of the strong interaction, focusing on the role of color charges in creating mass in glueballs.

Result: The study reveals that the interaction of color charges among multiple gluons leads to the formation of massive glueballs, offering insights into the mechanism of mass generation in strongly interacting systems.

Conclusion: Glueballs provide a unique framework for studying the mass creation in strongly interacting particles due to their unique properties and interactions.
...
### [19] [Polytropic $f(Q)$ cosmology and its implications for the $H_0$ tension](https://arxiv.org/abs/2604.11821)
*Raja Solanki*

Main category: gr-qc

TL;DR: This paper investigates the dark energy problem by adopting a polytropic equation of state and a $f(Q)$ cosmology. It derives exact cosmological solutions and uses Bayesian statistics to constrain parameters, providing insights into physical quantities like deceleration and statefinder parameter. The model also addresses the $H_0$ tension.


<details>
  <summary>Details</summary>
Motivation: To analyze the nature of the missing fluid in the universe, which is crucial for understanding the late-time cosmic phenomenon known as the dark energy problem. This work aims to provide a new perspective by utilizing a flexible polytropic equation of state and a recently proposed $f(Q)$ cosmology, which can help resolve some tensions in the field of cosmology.

Method: A polytropic equation of state with free parameters is used instead of assuming a specific form for the fluid. The background geometry is considered as a $f(Q)$ cosmology with a power-law assumption. Bayesian statistics and the emcee ensemble sampler are employed to find parameter constraints and interpret physical interests such as deceleration and statefinder parameter. The $H_0$ tension is predicted within the framework of the polytropic $f(Q)$ cosmological model.

Result: Exact cosmological solutions are obtained along with rigorous data analysis using Bayesian statistics and the emcee ensemble sampler. Parameter constraints are found, and physical parameters such as deceleration and statefinder parameter are interpreted. The status of the $H_0$ tension is presented within the context of the polytropic $f(Q)$ cosmological model.

Conclusion: The study provides a novel approach to understanding the dark energy problem by employing a polytropic equation of state and a $f(Q)$ cosmology. The exact cosmological solutions and parameter constraints are derived using Bayesian statistics, offering insights into physical parameters like deceleration and statefinder parameter. The model also predicts the status of the $H_0$ tension.
...
### [20] [Shadow of rotating black hole surrounded by dark matter](https://arxiv.org/abs/2604.11822)
...
### [21] [Astrophysical Signatures of Einstein-Skyrme Anti-de Sitter Black Holes: Epicyclic Frequencies and QPO Constraints](https://arxiv.org/abs/2604.11844)
...
### [22] [Quasi-resonances in the vicinity of Einstein-Maxwell-dilaton black hole](https://arxiv.org/abs/2604.11845)
*S. V. Bolokhov*
...
### [23] [Gravitational lensing around a Kerr-Sen black hole in plasma background](https://arxiv.org/abs/2604.11860)
*Saswati Roy,Shubham Kala,Sayanika Modak,Hemwati Nandan,Amare Abebe*

Main category: gr-qc

TL;DR: This paper studies gravitational lensing around a Kerr-Sen black hole in a plasma medium, considering both homogeneous and inhomogeneous distributions. It computes the light deflection angle and analyzes the effects of the black hole's properties and plasma on light bending, providing insights into plasma's role in modifying light propagation.


<details>
  <summary>Details</summary>
Motivation: The motivation stems from the need to understand the observational signatures of rotating charged black holes in realistic astrophysical environments. Considering both homogeneous and inhomogeneous plasma distributions allows for a more comprehensive analysis that mimics real-world scenarios.

Method: The method involves computing the light deflection angle and analyzing the conditions for circular photon orbits in both homogeneous and inhomogeneous plasma distributions. A comparison with the vacuum case is performed to emphasize the influence of plasma on light propagation.

Result: The results include the computation of the light deflection angle and the examination of the conditions for circular photon orbits under different plasma configurations. Comparisons with the vacuum case reveal the modifications introduced by plasma on light propagation.

Conclusion: The study provides a detailed analysis of gravitational lensing around a Kerr-Sen black hole in a magnetized, cold, pressureless plasma medium. It highlights the effects of the black hole's rotation and charge on light bending, as well as the role of plasma in modifying light propagation. The results offer a deeper insight into plasma effects, enhancing our understanding of observational signatures of rotating charged black holes.
...
### [24] [Gravitational wave signatures and periodic orbits of a charged black hole in a Hernquist dark matter halo](https://arxiv.org/abs/2604.11863)
*N. Heidari,A. A. Araujo Filho,Iarley P. Lobo*

Main category: gr-qc

TL;DR: This work investigates the motion of massive test particles and gravitational-wave emission around a magnetically charged black hole in a dark matter halo. It finds that dark matter parameters and magnetic charge affect the stability of orbits and gravitational-wave properties, with dark matter generally widening the allowed region and magnetic charge partially countering this effect. The study also constructs zoom-whirl configurations and analyzes gravitational-wave polarizations in the extreme mass-ratio regime.


<details>
  <summary>Details</summary>
Motivation: The motivation stems from the need to understand the dynamics of massive test particles and gravitational-wave emission in the presence of a magnetically charged black hole surrounded by a dark matter halo. This work aims to explore how dark matter parameters and magnetic charge affect the stability of orbits and the characteristics of gravitational waves.

Method: The research employs an analytical approach to analyze the effective potential and conditions for stable motion, focusing on the marginally bound radius and innermost stable circular orbit. Periodic trajectories are examined using rational numbers $q$, and representative zoom-whirl configurations are constructed. The investigation of gravitational-wave polarizations is conducted in the extreme mass-ratio regime.

Result: The results indicate that the dark matter density and scale radius increase the allowed region for stable motion, leading to larger characteristic radii and angular momenta. Magnetic charge, however, partially offsets these effects. Rational number $q$ characterizes the periodic trajectories, and zoom-whirl configurations along with their precessing versions are constructed. The study also examines the gravitational-wave polarizations in the extreme mass-ratio regime, influenced by dark matter and magnetic monopole charge.

Conclusion: The study reveals that the dark matter parameters and magnetic charge influence the allowed regions for stable motion around a magnetically charged black hole, with the former generally enlarging the region and shifting characteristic radii and angular momenta to larger values, while the latter partially counteracts this effect. The analysis of periodic trajectories through rational numbers $q$ provides insights into the zoom-whirl configurations and their precessing counterparts. Additionally, the paper investigates the impact of dark matter and magnetic monopole charge on gravitational-wave polarizations in the extreme mass-ratio regime.
...
### [25] [Beyond the Cosmological Constant: Breaking the Geometric Degeneracy of $ f(Q) $ cosmology via Redshift-Space Distortions](https://arxiv.org/abs/2604.11865)
...
### [26] [Equatorial periodic orbits and gravitational wave signatures in Euler-Heisenberg black holes surrounded by perfect fluid dark matter](https://arxiv.org/abs/2604.11866)
...
### [27] [Not too close! Evaluating the impact of the baseline on the localization of binary black holes by next-generation gravitational-wave detectors](https://arxiv.org/abs/2604.11871)
...
### [28] [Rotating Thin Shells in Einstein-Gauss-Bonnet Gravity](https://arxiv.org/abs/2604.11888)
...
### [29] [Relativistic signatures of scalar dark matter in extreme-mass-ratio inspirals](https://arxiv.org/abs/2604.11893)
...
### [30] [Novel ringdown tests of general relativity with black hole greybody factors](https://arxiv.org/abs/2604.11895)
...
### [31] [Post-Newtonian inspiral waveform model for eccentric precessing binaries with higher-order modes and matter effects](https://arxiv.org/abs/2604.11903)
...
### [32] [Distinguish Bardeen-like black holes by Gravitational lensing](https://arxiv.org/abs/2604.11951)
...
### [33] [Cosmologically viable non-polynomial quasi-topological gravity: explicit models, $Λ$CDM limit and observational constraints](https://arxiv.org/abs/2604.13002)
...
### [35] [Weakly turbulent dynamics on Schwarzschild-AdS black hole spacetimes](https://arxiv.org/abs/2604.12118)
...
### [36] [The balance problem for $n$ aligned black holes](https://arxiv.org/abs/2604.12134)
*Jörg Hennig*
...
### [37] [Blueshift of light rays induced by gravitational wave memory effect](https://arxiv.org/abs/2604.12135)
*F. L. Carneiro,S. C. Ulhoa,J. W. Maluf*

Main category: gr-qc

TL;DR: This paper examines how photons propagate in pp-wave spacetimes under strong gravitational waves, revealing an energy memory effect that causes a finite shift in photon frequency. This effect can explain discrepancies in supernova redshift data due to gravitational radiation.


<details>
  <summary>Details</summary>
Motivation: The motivation for this research stems from the need to understand the effects of strong gravitational waves on light propagation, particularly in the context of redshift measurements. This is crucial for interpreting astronomical observations, such as those from supernovae, where gravitational radiation can significantly alter the observed properties of light.

Method: The study employs theoretical analysis focusing on null geodesics in pp-wave spacetimes, utilizing principles from general relativity and gravitational wave physics. The approach involves solving the geodesic equations under the influence of a localized pp-wave pulse to derive the energy memory effect and its consequences on photon frequency shifts.

Result: The key result is the identification of an energy memory effect in the propagation of null geodesics through pp-wave spacetimes. This effect results in a finite asymptotic shift in the photon frequency measured by static observers. The path-dependent nature of this shift directly impacts the redshift observable, offering a potential explanation for discrepancies in supernova redshift data attributed to gravitational radiation.

Conclusion: The article investigates the propagation of photons in pp-wave spacetimes under strong gravitational-wave conditions and its impact on redshift measurements. It demonstrates that null geodesics crossing a localized pp-wave pulse exhibit an energy memory effect, leading to a finite asymptotic shift in the photon frequency observed by static observers. This path-dependent contribution directly influences the redshift observable and could help reconcile divergent interpretations of supernova redshift data when intervening gravitational radiation is present.
...
### [38] [Mixmaster chaos in a quantum scenario:a Deformed Algebra approach](https://arxiv.org/abs/2604.12760)
...
### [39] [SN 2022riv in RX J2129: Discovery, Spectroscopic Classification, and Microlensing of a Strongly Lensed Type Ia Supernova from JWST and HST Observations](https://arxiv.org/abs/2604.11882)
...
### [40] [Model-Independent Analysis of Type Ia Supernova Datasets and Implications for Dark Energy](https://arxiv.org/abs/2604.11883)
...
### [41] [Effective field theory of a single scalar pion field for large scale structure in the Universe](https://arxiv.org/abs/2604.12009)
...
### [42] [Beyond the Standard Model of Cosmology: Testing new paradigms with a Multiprobe Exploration of the Dark Universe](https://arxiv.org/abs/2604.12020)
*Juan Garcia-Bellido*
...
### [43] [Constraints on Coupled Dark Energy in the DESI Era](https://arxiv.org/abs/2604.12032)
...
### [44] [Probing Collapsed Dark Matter Halos with Fast Radio Bursts](https://arxiv.org/abs/2604.12189)
...
### [45] [Primordial Black Holes Formation Beyond the Standard Cosmic QCD Transition](https://arxiv.org/abs/2604.12581)
*Maël Gonin,Oleksii Ivanytskyi,David Blaschke,Günther Hasinger*

Main category: astro-ph.CO

TL;DR: This paper reviews the role of primordial black holes (PBHs) in the dark ages of cosmic evolution and as potential dark matter candidates. It focuses on the cosmological QCD phase transition and the impact of physics beyond the Standard Model on PBH formation and the cosmic equation of state.


<details>
  <summary>Details</summary>
Motivation: The motivation behind this paper is to understand the significance of PBHs in the early universe, particularly their role in the dark ages and as DM candidates. By examining the cosmological QCD phase transition and the effects of physics beyond the SM, the paper aims to provide insights into the formation mechanisms and the potential contributions of PBHs to present-day astrophysical phenomena.

Method: The research employs a recent microscopical model to focus on the cosmological QCD phase transition and its role in PBH formation. It investigates the influence of physics beyond the SM on the cosmic equation of state and the formation probability of PBHs.

Result: The findings suggest that the cosmological QCD phase transition plays a crucial role in the formation of PBHs, which can serve as DM candidates and contribute to binary black-hole mergers. The exploration of physics beyond the SM reveals how these theories can affect the cosmic equation of state and the probability distribution for PBH formation.

Conclusion: The paper discusses the role of primordial black holes (PBHs) in illuminating the dark ages of cosmic evolution and as potential dark matter candidates. It explores the formation of PBHs during the cosmological QCD phase transition, considering physics beyond the Standard Model (SM). The study also examines the impact of these physics on the cosmic equation of state and the probability distribution for PBH formation, which could contribute to current binary black-hole merger events.
...
### [46] [Impact of the SNe Ia Magnitude Transition at 20 Mpc on Cosmological Parameter Estimation](https://arxiv.org/abs/2604.12587)
...
### [47] [Illuminating the Local Universe: Large-Scale Structure from ZTF Type Ia Supernovae](https://arxiv.org/abs/2604.12714)
...
### [48] [Revisiting the angular size-redshift cosmological test with milliarcsecond radio structures in active galactic nuclei](https://arxiv.org/abs/2604.12936)
...
### [49] [Do equation of state parametrizations of dark energy faithfully capture the dynamics of the late universe?](https://arxiv.org/abs/2604.12987)
...
### [50] [Probing Scalar-Tensor-Induced Gravitational Waves in the nHz Band: $\texttt{NANOGrav}$ and SKA](https://arxiv.org/abs/2604.13012)
...
### [51] [Generalized symmetries and emergence in axion effective field theories](https://arxiv.org/abs/2604.11877)
*Dan Sehayek,Nathaniel Craig*

Main category: hep-th

TL;DR: We investigate how higher symmetry structures in axion effective field theories affect the emergence of symmetries in the infrared. We find that these constraints are universally satisfied by anomaly inflow onto topological defects, a non-perturbative effect, while they are supererogatory in perturbative UV completions due to scale separation.


<details>
  <summary>Details</summary>
Motivation: The motivation for this study is to understand the role of higher symmetry structures in axion effective field theories. Higher-group and non-invertible symmetries provide a framework to constrain the energy scales at which different symmetries can emerge in the infrared, offering insights into the underlying ultraviolet physics. By clarifying and analyzing these emergence constraints, we aim to bridge the gap between the phenomenological predictions of axion EFTs and the theoretical understanding of their UV completions.

Method: We analyze the phenomenological consequences of higher symmetry structures in axion effective field theories, focusing on higher-group and non-invertible symmetries. We study the emergence constraints imposed by these symmetries and their implications for the ultraviolet physics. Our analysis includes axion EFTs coupled to both abelian and non-abelian gauge bosons, with and without charged matter.

Result: Our results show that the emergence constraints in axion EFTs are universally saturated by anomaly inflow onto topological defects, indicating a non-perturbative mechanism. This contrasts with perturbative UV completions, where these constraints are supererogatory due to the large separation of scales. The analysis covers various scenarios, including axion EFTs coupled to abelian and non-abelian gauge bosons, with and without charged matter.

Conclusion: We conclude that the emergence constraints in axion effective field theories are universally saturated by anomaly inflow onto topological defects, which is a non-perturbative effect. In contrast, in perturbative UV completions, these constraints are supererogatory due to the parametric separation of scales.
...
### [52] [Manifest duality and Lorentz covariance for linearised gravity as edge modes](https://arxiv.org/abs/2604.11884)
...
### [53] [Thermodynamics of Chern-Simons AdS$_5$ black holes coupled to $\mathrm{SU}(2)$ solitons](https://arxiv.org/abs/2604.11894)
...
### [54] [Strong coupling dynamics of defect RG flows in ABJM](https://arxiv.org/abs/2604.11896)
...
### [56] [From Vacuum to Nucleon: Exact Fixed-Scale Matching of Holographic Current Correlators to QCD](https://arxiv.org/abs/2604.12037)
*Kiminad A. Mamo*
...
### [57] [Holographic Open/Closed Exchange in Double Deeply Virtual Compton Scattering: Fixed--$j$ Structural Matching to the $\pm$-Basis Wilson Coefficients](https://arxiv.org/abs/2604.12038)
*Kiminad A. Mamo*
...
### [58] [On a Deformed Holomorphic Chern-Simons Theory](https://arxiv.org/abs/2604.12055)
...
### [59] [Arithmetic turbulence: Algebraic derivation of the Euler ensemble attractor](https://arxiv.org/abs/2604.12207)
*Alexander Migdal*
...
### [60] [Fermion-fermion scattering in a Rarita-Schwinger model with Yukawa-like interaction](https://arxiv.org/abs/2604.12716)
*M. C. Araújo,J. G. Lima,J. Furtado,T. Mariz*

Main category: hep-th

TL;DR: This paper examines the scattering of spin-$3/2$ fermions mediated by a Yukawa-like interaction in the massive Rarita-Schwinger model. It uses Thermofield Dynamics to account for finite temperature effects and calculates cross sections in both zero and finite temperature regimes, focusing on the impact of temperature on scattering behavior in short- and long-range interactions.


<details>
  <summary>Details</summary>
Motivation: The motivation for this work is to study the scattering properties of spin-$3/2$ fermions under Yukawa-like interactions within the framework of the massive Rarita-Schwinger model. This investigation aims to understand how temperature affects these scattering processes, particularly in the context of short- and long-range interactions.

Method: The method involves replacing $m 	o m_ψ + gφ$ in the free spin-$3/2$ Lagrangian to introduce the interaction. The analysis is performed at both zero and finite temperatures. In the finite temperature case, TFD is used to incorporate thermal effects. The differential and total cross sections are calculated and their behavior in different limits is studied.

Result: The results include the derivation of differential and total cross sections for the scattering process. These cross sections are analyzed in the short-range and long-range limits, considering both zero and finite temperatures. The behavior of the cross sections in these limits provides insights into the role of temperature on the scattering dynamics.

Conclusion: The paper investigates the scattering of spin-$3/2$ fermionic particles mediated by a Yukawa-like coupling in the massive Rarita-Schwinger model. The analysis is conducted at zero and finite temperatures, with thermal effects incorporated using Thermofield Dynamics (TFD). The differential and total cross sections are obtained and their behavior in the short-range ($m_φ 
eq 0$) and long-range ($m_φ = 0$) limits is examined to analyze the influence of temperature effects.
...
### [61] [Symmetries of massless QCD](https://arxiv.org/abs/2604.12826)
*A. V. Smilga*

Main category: hep-th

TL;DR: The paper offers a detailed, educational overview of the theoretical outcomes when quarks have no mass, exploring implications for particle interactions and the structure of matter in a simplified model.


<details>
  <summary>Details</summary>
Motivation: The motivation for this work is to provide an educational resource that explains complex theoretical concepts related to particle physics, specifically focusing on the behavior of massless quarks in a hypothetical scenario. This could be aimed at students or researchers looking to deepen their understanding of quantum chromodynamics (QCD) under specific conditions.

Method: The method involves a detailed examination and explanation of exact theoretical results, likely using mathematical frameworks such as renormalization group techniques and possibly lattice QCD simulations to explore the implications of massless quarks.

Result: The result of the paper includes a comprehensive analysis of the theoretical predictions and implications of having massless quarks, which may involve discussions on symmetry breaking, confinement, and the structure of hadrons in such a scenario. The findings might also include new insights into the renormalization properties of the theory and the behavior of particles at different energy scales.

Conclusion: This paper provides a pedagogical review of theoretical results on the physics of an imaginary world where quarks are massless.
...
### [62] [Mixed-helicity bracket of celestial symmetries](https://arxiv.org/abs/2604.12854)
...
### [63] [The Hidden Symmetries of Yang-Mills Theory in (1+1)-dimensions](https://arxiv.org/abs/2604.12873)
...
### [64] [Infrared Spectral Gap in a Gluonic Dark Sector as the Origin of the Galactic Acceleration Scale](https://arxiv.org/abs/2604.12910)
...
### [65] [State counting in gravity and maximal entropy principle](https://arxiv.org/abs/2604.12980)
*Juan Hernandez,Mikhail Khramtsov*

Main category: hep-th

TL;DR: This paper uses the gravity path integral to show that the state-counting interpretation of black hole entropy and the Page curve for entanglement entropy of Hawking radiation are equivalent. This equivalence resolves the information loss puzzle by considering a complete basis of black hole microstates.


<details>
  <summary>Details</summary>
Motivation: The motivation behind this paper is to address the information loss puzzle in black hole physics, specifically the apparent contradiction between unitarity and the observed behavior of Hawking radiation. By connecting the state-counting interpretation of black hole entropy with the Page curve for entanglement entropy, the paper aims to provide a resolution within the framework of gravity path integrals.

Method: The authors use a convex optimization problem for the von Neumann entropy of Hawking radiation to relate the two questions. The method involves leveraging the semiclassical approximation to the gravity path integral, which allows for the exploration of quantum aspects of gravity.

Result: The paper shows that the state-counting interpretation of Bekenstein-Hawking entropy and the Page curve for entanglement entropy of Hawking radiation can be derived from the same underlying principles within the gravity path integral formalism. This equivalence provides a resolution to the information loss puzzle by ensuring that any (over)complete basis of black hole microstates is compatible with the entropy calculation.

Conclusion: The paper demonstrates that the state-counting interpretation of Bekenstein-Hawking entropy and the Page curve for entanglement entropy of Hawking radiation are equivalent from the perspective of the gravity path integral. This equivalence resolves the Hawking's information loss puzzle by considering a complete basis of black hole microstates.
