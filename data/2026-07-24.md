...
### [13] [Graviton-induced which-path decoherence in matter-wave interferometry](https://arxiv.org/abs/2607.20867)
*Hiroki Matsui*
...
### [14] [Using horizon shadows to distinguish a black hole and a white hole](https://arxiv.org/abs/2607.20945)
...
### [15] [New generalization of the Barboza-Alcaniz parametrization of Dark energy](https://arxiv.org/abs/2607.21064)
*Shahab Shahidi*
...
### [16] [The leading-soft cubic graviton self-interaction on the black-hole horizon](https://arxiv.org/abs/2607.21066)
*Ayanendu Dutta*
...
### [17] [Spin-mediated modulation of chaos bound violation in Lorentz-violating black hole spacetimes](https://arxiv.org/abs/2607.21165)
...
### [18] [Zipoy--Voorhees spacetime with Maxwell and dilaton fields: exact solution and equatorial geodesics](https://arxiv.org/abs/2607.21283)
*Haryanto M. Siahaan*
...
### [19] [Cosmological initial data without periodic boundary conditions](https://arxiv.org/abs/2607.21308)
*Károly Csukás*
...
### [20] [Octupole moments and the non-universality of free-fall in general relativity](https://arxiv.org/abs/2607.21314)
...
### [21] [A story about a tipsy kangaroo: Reversible jump MCMC for model selection in the analysis of gravitational-wave signals from the coalescence of compact objects](https://arxiv.org/abs/2607.21484)
...
### [22] [Tensor resonances in teleparallel Gauss-Bonnet branes](https://arxiv.org/abs/2607.20567)
...
### [23] [Moduli-Space Laplacians, Asymptotic Geometry, and the Emergent String Conjecture](https://arxiv.org/abs/2607.20603)
...
### [24] [Towards Generalized Dimers for GTPs: $\mathcal{N}=2$ Fractional Branes at Infinite Coupling](https://arxiv.org/abs/2607.20607)
...
### [25] [New Type IIB Poly-instanton Effects and Axion Quintessence](https://arxiv.org/abs/2607.20613)
...
### [26] [Sp(4,Z) actions on 3d U(1)^2 symmetric theories: Order-five duality and bilayer quantum Hall hierarchies](https://arxiv.org/abs/2607.20622)
...
### [27] [Uniqueness of null-local modular flow](https://arxiv.org/abs/2607.20678)
...
### [28] [Flux Vacua Near the Boundary of Large Complex Structure](https://arxiv.org/abs/2607.20777)
...
### [29] [Quantum Mpemba effect in holography](https://arxiv.org/abs/2607.20899)
...
### [30] [Coherent states versus Glauber-Sudarshan States: Bootstrapping, Schwinger-Keldysh Contours and Lefschetz Thimbles](https://arxiv.org/abs/2607.20927)
...
### [31] [Boundary Completion of Vacuum Persistence Probability](https://arxiv.org/abs/2607.20936)
...
### [32] [Flavour current correlators and the non-Abelian hydrodynamic approximation: the charged sector](https://arxiv.org/abs/2607.20991)
...
### [33] [Selecting Complex Extremal Surfaces with the Kontsevich--Segal--Witten Criterion](https://arxiv.org/abs/2607.21030)
*Wu-zhong Guo*
...
### [34] [Gauge-Theoretical Method in Solving Zero-curvature Equations III --Gauge Theoretical Method and the Bäcklund Transformations for Solitons--](https://arxiv.org/abs/2607.21052)
...
### [35] [One-point holographic correlator in the expanding universe](https://arxiv.org/abs/2607.21107)
...
### [36] [Carroll fermions of arbitrary spin](https://arxiv.org/abs/2607.21124)
...
### [37] [Energy-Energy Correlators at Strong Coupling](https://arxiv.org/abs/2607.21139)
...
### [38] [Defect entanglement entropy for superconformal RG Interfaces](https://arxiv.org/abs/2607.21270)
...
### [39] [Diagonally gauged anomaly-free 6D supergravities and their vacua](https://arxiv.org/abs/2607.21311)
...
### [40] [High-Order Pole-Skipping in Near-Extremal Holography](https://arxiv.org/abs/2607.21386)
...
### [41] [Wilson Towers as Local Bulk Fields](https://arxiv.org/abs/2607.21397)
...
### [42] [Relational path integral, effective actions and quantum frame covariance](https://arxiv.org/abs/2607.21463)
...
### [43] [A universal scaling function for giant graviton OPE coefficients](https://arxiv.org/abs/2607.21472)
...
### [44] [3d-3d correspondence for knot complements with finite and large $N$](https://arxiv.org/abs/2607.21479)
*Hee-Joong Chung*
...
### [45] [Aspects of Closed Matricial Worlds](https://arxiv.org/abs/2607.21509)
...
### [46] [Revealing the conformal symmetry of the discrete series scalars in dS${}_2$](https://arxiv.org/abs/2607.21514)
...
### [47] [On the strong coupling limit of Yang-Mills matrix models](https://arxiv.org/abs/2607.21593)
...
### [48] [Unveiling the Vanishing Higgsino-Nucleon Scattering in the MSSM at Next-to-Leading Order](https://arxiv.org/abs/2607.20588)
...
### [49] [Accidentally Stable Dark Matter in a Parity Solution to the Strong CP Problem](https://arxiv.org/abs/2607.20600)
...
### [50] [Earth rotation turns event timing into a geometric probe of UHE neutrino origin](https://arxiv.org/abs/2607.20608)
...
### [51] [Dark Matter Weather: Probing Sub-GeV Interactions with Earth-Shielding Modulation](https://arxiv.org/abs/2607.20620)
...
### [52] [Reheating the FCC: Probing Early Matter Domination with Long-Lived Particles](https://arxiv.org/abs/2607.20625)
...
### [53] [Hyperasymptotic Expansions in QCD: The Lightest Gluelump Mass Case](https://arxiv.org/abs/2607.20648)
*Antonio Pineda*
...
### [54] [Spin Structure of the Nucleon: Overview](https://arxiv.org/abs/2607.20761)
*Yoshitaka Hatta*
...
### [55] [Numerical Backreaction and Finite-Time Energy Transfer in Post-Recombination Magnetogenesis from Ultralight Dark Matter](https://arxiv.org/abs/2607.20793)
...
### [56] [The supernumerary $K(1690)$ signal from COMPASS as a strange hybrid state](https://arxiv.org/abs/2607.20825)
...
### [57] [Dark Monopoles, Bounds on Hidden Sectors, and Cosmological Implications](https://arxiv.org/abs/2607.20843)
...
### [58] [Charged Higgs Search at Future Neutrino Telescope and Higgs Factory](https://arxiv.org/abs/2607.20963)
...
### [59] [Advanced Statistical Analysis of Linear and Nonlinear Regge Trajectories for Light Non-strange Mesons](https://arxiv.org/abs/2607.21035)
*S. S. Afonin*
...
### [60] [MeV Electrophilic Axion-like Particles from Sun](https://arxiv.org/abs/2607.21168)
...
### [61] [Thermal Resummation for Very Strong First-order Phase Transitions](https://arxiv.org/abs/2607.21252)
*Philipp Klose*
...
### [62] [Transverse-momentum resummation effects on angular coefficients in Z and W boson hadroproduction](https://arxiv.org/abs/2607.21395)
...
### [63] [Heavy neutral leptons from light scalar in fixed target and forward search experiments](https://arxiv.org/abs/2607.21537)
...
### [64] [Neural solutions of coupled ghost and gluon Dyson--Schwinger equations in Landau gauge](https://arxiv.org/abs/2607.21548)
*Rodrigo Carmo Terin*
...
### [65] [Gauge coupling beta functions and gauge field anomalous dimensions at four loops in the Standard Model](https://arxiv.org/abs/2607.21586)
...
### [66] [Isotropic deceleration and near-zero baseline acceleration in Pantheon+ supernovae: new arguments in the dark energy debate](https://arxiv.org/abs/2607.20570)
...
### [67] [Gravitational Lensing Predictions from Wave Simulations of Fuzzy Dark Matter](https://arxiv.org/abs/2607.20614)
...
### [68] [What could an emerging Big Bang Nucleosynthesis discrepancy be hinting at?](https://arxiv.org/abs/2607.20635)
...
### [69] [The correlation between voids identified in 3D large-scale-structure and 2D weak-lensing maps](https://arxiv.org/abs/2607.20637)
...
### [70] [When galaxies burst II. Implications of enhanced burstiness for the 21-cm Cosmic Dawn signal](https://arxiv.org/abs/2607.20651)
...
### [71] [Probing the baryonic--dark matter connection in galaxy clusters using X-rays with gated recurrent unit neural networks](https://arxiv.org/abs/2607.20721)
...
### [72] [A Multimodal Approach to Star--Galaxy Separation using SPHEREx Spectrophotometry and DESI Legacy Survey Imaging](https://arxiv.org/abs/2607.20797)
...
### [73] [A lower bound on primordial power spectrum from halo substructure](https://arxiv.org/abs/2607.20884)
...
### [74] [Reviving the Affleck-Dine Curvaton Scenario with Compensated Isocurvature Perturbations](https://arxiv.org/abs/2607.21008)
...
### [75] [Inferences for f(R) Models from Late-Time Megamaser Observational Data](https://arxiv.org/abs/2607.21129)
...
### [76] [Hubble tension: the shape wall](https://arxiv.org/abs/2607.21244)
...
### [77] [Contribution to the 2026 Cosmology session of the 60th Rencontres de Moriond: Galactic moments: Understanding polarized foregrounds complexity in the quest for CMB primordial $B$ modes with LiteBIRD](https://arxiv.org/abs/2607.21247)
...
### [78] [Web-Halo Model Peak-Background Split (WHM-PBS): halo bias as a distribution, not a number](https://arxiv.org/abs/2607.21334)
...
### [79] [Hubble tension: a short review of theoretical explanations](https://arxiv.org/abs/2607.21497)
...
### [80] [The silent dark sector: a field-theory approach to unified dark fluids with vanishing speed of sound](https://arxiv.org/abs/2607.19494)
