...
### [26] [Analytic thermal bootstrap in momentum space: From thermal OPE to QNMs](https://arxiv.org/abs/2607.24919)
...
### [27] [Split Heun functions via blown-up surface defects](https://arxiv.org/abs/2607.24920)
...
### [28] [Unitary Dual-Resonance S-matrices](https://arxiv.org/abs/2607.24922)
...
### [29] [Feynman Tree Theorem and the Gelfand--Yaglom Formula](https://arxiv.org/abs/2607.24923)
...
### [30] [Cross-Correlations of Metric and Monopole Perturbations from Holographic Cosmology](https://arxiv.org/abs/2607.24989)
...
### [31] [Quantum Gravity Corrections to Giant Graviton Correlators](https://arxiv.org/abs/2607.25054)
...
### [32] [A discrete series gauge field at the late-time boundary of $dS_4$](https://arxiv.org/abs/2607.25067)
...
### [33] [Derivation of the NS5-brane limit of the plane wave matrix model](https://arxiv.org/abs/2607.25116)
...
### [34] [Monodromy, Hidden Conformal Symmetry and Soft Hair in Kerr-MOG Black Hole](https://arxiv.org/abs/2607.25205)
...
### [35] [The quantum electrodynamics for dyons](https://arxiv.org/abs/2607.25226)
...
### [36] [String theory mathematics and matrix data analysis](https://arxiv.org/abs/2607.25500)
*Sanjaye Ramgoolam*
...
### [37] [Toward the Structure Constants of $\mathcal{N}=2$ Liouville Theory](https://arxiv.org/abs/2607.25662)
...
### [43] [Cosmological evolution with decaying dark matter: an integral-equation approach](https://arxiv.org/abs/2607.24910)
...
### [44] [Correlated signals of ultralight scalar dark matter in pulsar timing](https://arxiv.org/abs/2607.24912)
...
### [45] [Interlopers as Signal in Line Intensity Mapping](https://arxiv.org/abs/2607.24917)
*Anirban Roy*
...
### [46] [Primordial Physics in the Nonlinear Universe: Revealing the oscillating halo bias from cosmological collider models](https://arxiv.org/abs/2607.24939)
...
### [47] [EFT-Ramses: a code to simulate the effective field theory of dark energy](https://arxiv.org/abs/2607.24940)
...
### [48] [CosmoLattice 2.0](https://arxiv.org/abs/2607.24978)
...
### [49] [Gravitational Waves from Superconducting Cosmic Strings](https://arxiv.org/abs/2607.25317)
...
### [50] [Neutrino-electron scattering kernels in isotropic media](https://arxiv.org/abs/2607.25436)
...
### [51] [No preference for generalized emergent dark energy from current cosmological data](https://arxiv.org/abs/2607.25539)
...
### [52] [Simulation-based tension quantification of the cosmic dipole](https://arxiv.org/abs/2607.25703)
...
### [53] [Robust Ly$α$ forest constraints on reionization from semi-analytic galaxy formation models](https://arxiv.org/abs/2607.25722)
...
### [54] [Anisotropic Secondary Bias of Dark Matter Haloes in a $Λ$CDM Universe](https://arxiv.org/abs/2607.26009)
*Qinglin Ma,Cheng Li*
...
### [55] [Weighted Webs: Morphology-Informed Marked Fields](https://arxiv.org/abs/2607.26021)
...
### [56] [Minimally modified gravity with Laplacian auxiliary constraints and an inflationary realization](https://arxiv.org/abs/2607.26031)
...
### [57] [Probing Parity Violation with Weak Lensing Trispectrum](https://arxiv.org/abs/2607.26046)
...
### [58] [$Λ$XCDM: a running vacuum strategy for crossing the phantom divide](https://arxiv.org/abs/2607.26050)
...
### [59] [Sum-Rule-Preserving Non-Factorized Transition-GPD Tomography of $N\toΔ(1232)$ Multipole Structure](https://arxiv.org/abs/2607.24864)
*R. M. Marinaro*
...
### [60] [Probing long-range $L_e-L_μ$ forces with supernova neutronization burst neutrinos](https://arxiv.org/abs/2607.24918)
...
### [61] [Simplex Demixing: Disentangling Multiple Light-Flavor Jets at Colliders](https://arxiv.org/abs/2607.24921)
...
### [62] [Bound-state beta decay of tritium: Path to first observation and novel approach to direct neutrino mass measurement](https://arxiv.org/abs/2607.24928)
...
### [63] [Gravitational waves decay in vacuum: a low energy effect of quantized gravitation](https://arxiv.org/abs/2607.24930)
...
### [64] [Multi-component Dark Matter in a Novel Three-Loop Inverse Scotogenic Seesaw Model](https://arxiv.org/abs/2607.24932)
...
### [65] [Coherence from interference: a solvable model of sub-GeV dark matter-nucleus scattering](https://arxiv.org/abs/2607.24933)
...
### [66] [Top-quark mass interpretation from simulation of top-flavoured mesons](https://arxiv.org/abs/2607.24935)
...
### [67] [Beyond leading-logarithm photon production from two-loop diagrams in a hot QCD medium](https://arxiv.org/abs/2607.24950)
...
### [68] [NNLO Determination of Polarized Parton Distribution Functions with Higher-Twist and Target-Mass Corrections](https://arxiv.org/abs/2607.25001)
...
### [69] [Regarding the Rotational Unruh Effect](https://arxiv.org/abs/2607.25004)
...
### [70] [Searches for heavy neutral lepton decays at spallation neutron sources](https://arxiv.org/abs/2607.25008)
...
### [71] [Few-gluon interactions and multipole radiation in high energy nuclear collisions](https://arxiv.org/abs/2607.25017)
*Thomas A. Trainor*
...
### [72] [Quantum detection of CP violation in the $t\bar{t}$ system: production](https://arxiv.org/abs/2607.25029)
...
### [73] [Quantum detection of CP violation in the $t\bar{t}$ system: tomography](https://arxiv.org/abs/2607.25034)
*Priyanka Lamba,Fabio Maltoni,Olimpia Miniati,Eleni Vryonidou*
...
### [78] [Heavy Jet Mass in Hadronic Higgs Decays](https://arxiv.org/abs/2607.25187)
...
### [79] [Isolating Scheme Dependence of Quasi-PDFs in the RI/MOM Scheme](https://arxiv.org/abs/2607.25231)
*Junegone Chay*
...
### [80] [Spatial Guidance Field Theory: From Gradient Postulates and Charge Conservation to Gauge Group Structure](https://arxiv.org/abs/2607.25336)
*Xinqiao Li*
...
### [81] [Singly heavy tetraquarks](https://arxiv.org/abs/2607.25401)
...
### [82] [Distinguishing the Axion-Wind and Oscillating-EDM Couplings in Storage-Ring Searches for Axion Dark Matter](https://arxiv.org/abs/2607.25466)
*V. Hejny,J. Pretz*
...
### [83] [Photon Gas Thermodynamics in Doubly Special Relativity at the Planck Scale](https://arxiv.org/abs/2607.25473)
...
### [84] [Pseudoscalar Yukawa Coupling Induced Helical Asymmetry in Fermionic Preheating](https://arxiv.org/abs/2607.25521)
...
### [85] [Virtual state and two-pole structure: $Ξ(1690)$ and $Ξ(1820)$ from BESIII data on $ψ(3686)\to K^-Λ\barΞ^+$](https://arxiv.org/abs/2607.25606)
*Jun He*
...
### [86] [Constraining axion quadratic couplings with the Hulse-Taylor binary system](https://arxiv.org/abs/2607.25631)
...
### [87] [The 95 GeV Excess in Models with Two Higgs Doublets plus One Singlet: Model Distinction via Four-top Final States and Triple Higgs Couplings](https://arxiv.org/abs/2607.25670)
...
### [88] [Compositeness relations for near-threshold p-wave bound states](https://arxiv.org/abs/2607.25744)
*Guo-Ying Chen*
...
### [89] [Heavy and heavy-light mesons with arbitrary spin and parity in the Covariant Spectator Theory](https://arxiv.org/abs/2607.25747)
...
### [90] [A dispersive method to study CP asymmetries in hadronic multi-body $B$ decays](https://arxiv.org/abs/2607.25764)
...
### [91] [Form factors of the $ρ$-meson in chiral perturbation theory](https://arxiv.org/abs/2607.25844)
...
### [92] [Probing the limits on anomalous quartic gauge couplings via $ZZγ$ production in the $\ell\ellννγ$ channel at FCC-hh](https://arxiv.org/abs/2607.25935)
...
### [93] [Probing Lepton-Flavor-Violating Four-Lepton Operators at a Muon Collider](https://arxiv.org/abs/2607.26020)
