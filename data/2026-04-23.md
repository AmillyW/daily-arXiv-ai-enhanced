...
TL;DR: We propose a novel search strategy at the LHC to detect GeV-scale particles coupling to light quarks, using low-multiplicity jets associated with a hard photon. This method enhances sensitivity to scalar and pseudoscalar couplings and reduces uncertainties, thereby extending the reach to previously inaccessible regimes.


<details>
  <summary>Details</summary>
Motivation: The motivation is to extend the search for hadronically-coupled particles at the LHC into a previously unexplored region by utilizing the unique decay properties of light gauge-singlets, which produce jets with distinct characteristics compared to standard QCD jets.

Method: The method involves searching for GeV-scale particles in association with a hard photon, focusing on jets with anomalously low charged-track multiplicity and mass compared to QCD jets at the same transverse momentum. Sensitivity is calculated for scalar and pseudoscalar couplings to up-quarks, and a data-driven estimate is used to reduce uncertainties related to jet modeling.

Result: The result is the determination of sensitivity to scalar and pseudoscalar couplings to up-quarks, and the suggestion of a data-driven estimate to reduce jet modeling uncertainties. This search effectively extends the detection capability for hadronically-coupled particles at the LHC.

Conclusion: The proposed search at the LHC aims to detect GeV-scale particles that predominantly couple to light quarks, leveraging low-multiplicity jets associated with a hard photon. The sensitivity is determined for scalar and pseudoscalar couplings to up-quarks, and a data-driven estimate is suggested to mitigate jet modeling uncertainties. This approach extends the reach to hadronically-coupled particles into a previously inaccessible regime.
...
TL;DR: This paper investigates a dark matter model featuring magnetic monopoles under a dark U(1) symmetry with kinetic mixing. It discusses three phenomenological cases based on the dark sector's temperature and spontaneous symmetry breaking scale. Constraints on dark matter self-interactions are derived, and the Parker effect adds further restrictions on the kinetic mixing due to the preservation of galactic magnetic fields.


<details>
  <summary>Details</summary>
Motivation: The motivation stems from the rich phenomenology of a dark matter sector composed of magnetic monopoles under a dark U(1) symmetry with kinetic mixing. This model not only offers interesting cosmological implications but also provides a framework for understanding the interaction between dark and visible sectors. The study aims to explore how the temperature of the dark sector and the scale of spontaneous symmetry breaking affect the phenomenology and impose constraints on the model parameters.

Method: The method involves studying the phenomenological implications of a dark U(1) symmetry sector containing magnetic monopoles that have a small kinetic mixing with the Standard Model photon. Constraints on dark matter self-interactions are derived from the temperature of the dark sector and the scale of spontaneous symmetry breaking for this U(1). The Parker effect is used to place additional constraints on the mixing between the dark and visible sectors due to the survival of galactic magnetic fields.

Result: Three distinct phenomenological cases are discussed based on the temperature of the dark sector and the scale of spontaneous symmetry breaking for the U(1). Constraints on dark matter self-interactions are translated into constraints on the model parameters in all cases. The Parker effect, which ensures the survival of galactic magnetic fields, imposes further constraints on the kinetic mixing between the dark and visible sectors.

Conclusion: The analysis of the dark matter model with magnetic monopoles and kinetic mixing provides insights into both phenomenology and theoretical constraints. The Parker effect further constrains the model parameters, highlighting the interplay between dark and visible sectors.
...
### [3] [A First Account of the Impact of Ion Electromagnetic Dissociation on Event Exclusivity in Ultraperipheral LHC Collisions](https://arxiv.org/abs/2604.19879)
*M. Dyndal,L. A. Harland-Lang*

Main category: hep-ph

TL;DR: This Letter investigates hadron production in EMD processes at LHC energies, showing it impacts exclusive particle production measurements and resolves theoretical-experimental discrepancies.


<details>
  <summary>Details</summary>
Motivation: To explore the modeling of hadron production in electromagnetic ion dissociation (EMD) processes at high-energy ultraperipheral collisions at LHC energies, where EMD can accompany exclusive particle production, and to demonstrate how this affects existing LHC measurements.

Method: The authors calculate the impact on existing LHC measurements of exclusive muon pair production ($γγ\toμμ$) and exclusive coherent $J/ψ$ production, demonstrating that accounting for hadron production breaks exclusivity vetos and resolves these tensions.

Result: The calculation shows that including hadron production in EMD processes impacts existing LHC measurements of exclusive muon pair production and exclusive coherent $J/ψ$ production. This inclusion breaks exclusivity vetos and resolves long-standing tensions between theoretical predictions and experimental measurements.

Conclusion: The inclusion of hadron production in EMD processes resolves long-standing tensions between theoretical predictions and experimental measurements for exclusive particle production.
...
### [4] [Spontaneous Baryogenesis from Axions on Induced Electroweak Walls](https://arxiv.org/abs/2604.20762)
...
### [6] [Primordial Magnetogenesis and Gravitational Waves from ALP-assisted Phase Transition](https://arxiv.org/abs/2604.20768)
...
TL;DR: This paper examines the sensitivity of neutrino observatories and direct dark matter detection experiments to sub-GeV dark matter produced by cosmic ray collisions in the atmosphere. It enhances the sensitivity through a new model of proton bremsstrahlung production and compares the performance of various experiments including LZ, PandaX-4T, Borexino, and Super-K.


<details>
  <summary>Details</summary>
Motivation: The motivation is to explore the sensitivity of neutrino observatories and direct dark matter detection experiments to boosted sub-GeV dark matter produced by inelastic cosmic ray collisions in the atmosphere. This is particularly relevant for vector-mediated dark matter models where the peak of the cosmic ray flux can enhance DM production near $ρ/ω$ resonances.

Method: The method involves revisiting earlier approaches and extending the sensitivity to higher mass by modeling the proton bremsstrahlung production mode via initial state radiation. For vector-mediated dark matter models, the peak of the cosmic ray flux allows for enhanced DM production for mediator masses near the $ρ/ω$ resonances. Sensitivity comparisons are made between direct detection experiments LZ and PandaX-4T and the neutrino detectors Borexino and Super-K.

Result: The result includes determining and comparing the sensitivity of direct detection experiments LZ and PandaX-4T with that of neutrino detectors Borexino and Super-K. The study focuses on the impact of proton bremsstrahlung production mode via initial state radiation on the sensitivity to boosted sub-GeV dark matter.

Conclusion: The study investigates the sensitivity of neutrino observatories and direct dark matter detection experiments to boosted sub-GeV dark matter produced by inelastic cosmic ray collisions in the atmosphere. It extends earlier approaches by modeling proton bremsstrahlung production mode via initial state radiation, enhancing the sensitivity for vector-mediated dark matter models near $ρ/ω$ resonances. The sensitivity of direct detection experiments LZ and PandaX-4T is compared with that of neutrino detectors Borexino and Super-K.
...
### [8] [Irreducible Gravitational Wave Background as a Particle Detector](https://arxiv.org/abs/2604.20792)
...
TL;DR: These notes provide supplementary material for various graduate schools focusing on nuclear and hadronic physics, enhancing students' understanding of the topics discussed in lectures and recitations.


<details>
  <summary>Details</summary>
Motivation: The motivation behind these notes is to enhance the understanding of students attending the graduate schools by providing a comprehensive guide that covers the key concepts and methodologies discussed in the lectures and recitations.

Method: The notes are designed to complement the lectures and recitation sessions by offering a more in-depth exploration of the subjects covered, including theoretical frameworks and practical applications.

Result: The result of this initiative is the creation of a set of notes that serve as a valuable resource for students, helping them to reinforce their learning and prepare for advanced studies or research in nuclear and hadronic physics.

Conclusion: This set of notes serves as a supplementary resource for the graduate schools mentioned, providing additional insights and detailed explanations on topics discussed in lectures and recitations.
...
### [10] [Photon and neutrino fluxes from spheroidal dwarf galaxies in a decaying DM model](https://arxiv.org/abs/2604.20086)
*A. Carrillo-Monteverde,L. López-Lozano,F. San Juan-Villegas*

Main category: hep-ph

TL;DR: This work investigates a decaying dark matter model with a scalar singlet and non-minimal gravitational coupling, computing gamma-ray and neutrino fluxes and predicting observable indirect detection signatures in specific regions of parameter space.


<details>
  <summary>Details</summary>
Motivation: The motivation is to explore a decaying dark matter scenario and its associated indirect detection signatures, aiming to provide a framework that can be tested through observations of gamma rays, neutrinos, and charged particles.

Method: The method involves constructing a theoretical model with a scalar singlet and $Z_2$ symmetry, calculating the gamma-ray and neutrino fluxes using numerical tools, and analyzing the expected number of events in selected experiments.

Result: The results include the computation of gamma-ray and neutrino fluxes for a candidate decaying dark matter model in the Milky Way and 14 dwarf spheroidal galaxies, along with the expected number of events in selected experiments. These results are presented for three benchmark masses and three coupling values consistent with cosmological constraints.

Conclusion: The study presents a decaying dark matter model with a scalar singlet and non-minimal gravitational coupling, which leads to observable indirect detection signatures such as gamma rays, neutrinos, and charged particles. The predicted signals are shown to be observable in specific regions of parameter space for three benchmark masses and three coupling values consistent with cosmological constraints.
...
TL;DR: A graph-theoretic method is introduced to analyze fermion mass spectra in lattice models, determining the number and localization of massless modes through graph properties.


<details>
  <summary>Details</summary>
Motivation: To develop a method for analyzing fermion mass spectra in lattice theory-space models, including chain models derived from dimensional deconstruction. This method leverages graph theory to systematically study the properties of massless modes.

Method: Fermion mass terms are mapped to bipartite graphs, where fields are vertices and nonvanishing mass terms are edges. The number of massless modes is determined by the cardinality of a maximum matching in the graph. The wave-function support of these modes is restricted to fields reachable from exposed or unmatched vertices via even-length maximum-matching-alternating paths, as characterized by the Dulmage-Mendelsohn decomposition.

Result: The method allows for the construction of lattice models with specified numbers and localization properties of massless modes, based solely on the topology of the lattice space.

Conclusion: The graph-theoretic method provides a systematic approach to construct lattice models with controlled numbers and localization properties of massless modes.
...
### [12] [Impact of nuclear deformation on particle production in $Ne+Ne$ collisions at \texorpdfstring{\five}{sqrt(sNN)=5.36 TeV} from AMPT-SM](https://arxiv.org/abs/2604.20152)
...
### [13] [Chiral first order phase transition at finite baryon density and zero temperature from self-consistent pole masses in the linear sigma model with quarks](https://arxiv.org/abs/2604.20196)
...
### [14] [Target-Mass Corrections in the OPE Sum-Rule Approach to Quarkonium-Nucleon Interactions with Global-Fit PDFs: an $x$-Resolved Analysis](https://arxiv.org/abs/2604.20217)
*Arkadiy I. Syamtomov*
...
### [15] [No planar degeneracy for the Landau gauge quark-gluon vertex](https://arxiv.org/abs/2604.20235)
...
### [16] [When Does Leptogenesis Survive Lepton Flavor Violation Constraints? High- and Low-Scale Realizations in the Scotogenic Model](https://arxiv.org/abs/2604.20239)
*Avinanda Chaudhuri*
...
### [17] [$J/ψ$ Photoproduction from Threshold to HERA: Leading-Twist Convolution, Small-$x$ Pathology, and Eikonal Unitarization](https://arxiv.org/abs/2604.20247)
*Arkadiy I. Syamtomov*
...
### [18] [A Lightning-Fast Three-Flavor Neutrino Oscillation Calculator in Constant-Density Matter with Built-In Uncertainty Propagation](https://arxiv.org/abs/2604.20275)
...
### [19] [Technically Natural Suppression of Fifth Force](https://arxiv.org/abs/2604.20292)
...
### [20] [Baryon-Meson Sum Rule for $b \to s ν\barν$](https://arxiv.org/abs/2604.20340)
...
### [23] [How Invisible: Regressing The Key Model Parameter for Semi-visible Jet Searches](https://arxiv.org/abs/2604.20456)
*Yin Li,Bingxuan Liu,Jianbin Wang,Jiaqi Xie,Kairong Xu,Ruihan Ye,Zihuan Huang*

Main category: hep-ph

TL;DR: A regression model is developed to accurately reconstruct $r_{\mathrm{inv}}$ in semi-visible jets (SVJs), improving the precision and sensitivity of collider searches involving strongly interacting dark sectors.


<details>
  <summary>Details</summary>
Motivation: To improve the precision of reconstructing $r_{\mathrm{inv}}$, which controls the fraction of dark hadrons decaying to dark matter candidates, in semi-visible jets (SVJs). This is crucial for enhancing the sensitivity of collider searches involving strongly interacting dark sectors.

Method: A regression model is developed that uses high-level physics objects to reconstruct $r_{\mathrm{inv}}$ in SVJ events associated with energetic photons. The training procedure is optimized for applicability across varying signal parameters.

Result: The performance of the regression model is robust against varying signal parameters, and it allows for the reconstruction of $r_{\mathrm{inv}}$ at a much higher precision than previously developed analytical methods. This new approach offers a unified method for conducting SVJ searches, potentially combining both $s$-channel and $t$-channel productions.

Conclusion: The developed regression model successfully reconstructs the key model parameter $r_{\mathrm{inv}}$ with higher precision compared to previous methods, enhancing the sensitivity of semi-visible jet (SVJ) searches. This approach can unify $s$-channel and $t$-channel productions, providing a robust method for collider physics.
...
### [24] [Dilaton-Induced Resonant Production of Ultralight Vector Dark Matter](https://arxiv.org/abs/2604.20481)
...
### [25] [Flavon assisted low scale leptogenesis](https://arxiv.org/abs/2604.20581)
...
### [26] [$P_{c\bar cs}(4459)^{0}$, $P_{c\bar c s}(4338)^0$ and mass spectrum of strange hidden-charm pentaquarks](https://arxiv.org/abs/2604.20618)
...
### [27] [Search for Axion Like Particles produced via the Primakoff process at COMPASS](https://arxiv.org/abs/2604.20734)
*Mehran Dehpour*
...
### [28] [Probing QCD instantons using jet correlation observables in proton-proton collisions at the LHC](https://arxiv.org/abs/2604.20780)
*Sayak Guin,Swagatam Tah,Nihar Ranjan Sahoo,Sayantan Sharma*

Main category: hep-ph

TL;DR: This paper proposes jet correlation observables to distinguish instanton-induced processes from perturbative hard scattering events in pp collisions at LHC energies, providing constraints on hadron center-of-mass energies. The approach is also applicable for future ep measurements at the Electron-Ion Collider.


<details>
  <summary>Details</summary>
Motivation: The motivation is to utilize jet correlation observables to discover instantons in colliders, which will provide experimental evidence for the topological properties of the QCD vacuum. This is particularly important for understanding the dynamics of strong interactions at high energies.

Method: The method involves calculating the sizes and separations of instantons in 2+1 flavor QCD with physical quark masses to constrain the center-of-mass energies of produced hadrons in an instanton-induced process. The proposal is designed to be directly applicable for future ep measurements at the Electron-Ion Collider.

Result: The result is the development of jet correlation observables that can unambiguously discriminate between instanton-induced processes and perturbative hard scattering events in pp collisions at LHC energies. These observables allow for the calculation of instanton sizes and their separations, leading to constraints on the center-of-mass energies of produced hadrons in an instanton-induced process.

Conclusion: The proposed jet correlation observables provide a means to distinguish between instanton-induced processes and perturbative hard scattering events in pp collisions at LHC energies, offering constraints on the center-of-mass energies of produced hadrons. This approach is also applicable for future ep measurements at the Electron-Ion Collider, providing a cleaner environment to probe instanton-induced processes.
...
### [29] [Van der Waals Gravity Theory](https://arxiv.org/abs/2604.19831)
*H. R. Fazlollahi*

Main category: gr-qc

TL;DR: We propose an extension of general relativity by integrating non-ideal thermodynamic effects, leading to modified gravitational field equations with a dynamically evolving effective gravitational coupling. This approach avoids initial singularities in cosmology and results in non-singular black hole solutions, suggesting a new path towards resolving fundamental singularities in classical gravitational theory.


<details>
  <summary>Details</summary>
Motivation: The motivation is to address the issue of initial singularities in standard Big Bang cosmology and the singularity problem in black hole physics within the framework of classical gravitational theory. By incorporating non-ideal thermodynamic effects, the study aims to provide a more consistent description of spacetime dynamics and potentially resolve these singularities.

Method: The study extends general relativity by integrating non-ideal thermodynamic effects into the gravitational sector, based on Jacobson's thermodynamic interpretation of gravity. The modified gravitational field equations are derived from the Clausius relation, leading to a dynamic evolution of the effective gravitational coupling.

Result: The study results in modified gravitational field equations where the effective gravitational coupling is no longer constant but evolves with the properties of the underlying spacetime system. This leads to significant consequences in high-energy regimes, including the avoidance of initial singularities in cosmology and the emergence of non-singular black hole solutions.

Conclusion: The proposed extension of general relativity, inspired by the van der Waals equation of state and incorporating non-ideal thermodynamic effects into the gravitational sector, leads to modified gravitational field equations with a dynamically evolving effective gravitational coupling. This dynamical behavior provides a natural mechanism for avoiding initial singularities in standard Big Bang cosmology and results in non-singular black hole solutions. These findings suggest that non-ideal thermodynamic features can offer a consistent route toward resolving fundamental singularities in classical gravitational theory.
...
### [30] [Greybody Factor, Resonant Frequencies, and Entropy Quantization of Charged Scalar Fields in the Kerr-EMDA Black Hole](https://arxiv.org/abs/2604.19848)
...
### [31] [Cosmology of the interacting Tsallis holographic dark energy in $f(R,T)$ gravity framework](https://arxiv.org/abs/2604.19849)
...
### [32] [Two-Point Padé Approximants for the Deflection of Light in the Schwarzschild Black Hole Metric](https://arxiv.org/abs/2604.19952)
*Don N. Page*
...
### [33] [Regular Black Holes in General Relativity from Nonlinear Electrodynamics with de Sitter Cores](https://arxiv.org/abs/2604.20066)
...
### [34] [Thermodynamics and phase transitions of nonlinearly scalarized black holes in Einstein-scalar-Gauss-Bonnet theory](https://arxiv.org/abs/2604.20153)
*De-Cheng Zou,Xu Yang,Meng-Yun Lai,Hyat Huang,Yun Soo Myung*

Main category: gr-qc

TL;DR: This paper investigates the thermodynamic properties of scalarized black holes in Einstein-scalar-Gauss-Bonnet theory, finding a first-order phase transition with non-zero latent heat from Schwarzschild to scalarized black holes.


<details>
  <summary>Details</summary>
Motivation: To explore the thermodynamic properties of static nonlinearly scalarized black holes in Einstein-scalar-Gauss-Bonnet theory, focusing on the phase transitions and the first law of black hole thermodynamics.

Method: The authors compute thermodynamical quantities of scalarized black holes and examine the first law of black hole thermodynamics. They also investigate phase transitions between Schwarzschild and scalarized black holes using previously constructed scalarized solutions.

Result: The computation of thermodynamical quantities for scalarized black holes and the examination of phase transitions reveal that the transition from Schwarzschild to scalarized black holes is a first-order process with non-zero latent heat, suggesting a distinct thermodynamic phase change.

Conclusion: The study reveals that the phase transition from Schwarzschild black hole to scalarized black hole is a first-order with non-zero latent heat, indicating a significant change in thermodynamic properties.
...
### [35] [Geodesic Completeness in General Cosmological Scenarios](https://arxiv.org/abs/2604.20809)
*William H. Kinney*

Main category: gr-qc

TL;DR: The BGV theorem is generalized to show that cyclic models, like those proposed by Ijjas and Steinhardt, can also be geodesically incomplete.


<details>
  <summary>Details</summary>
Motivation: To address the limitations of the original BGV theorem by considering a broader class of spacetime models beyond inflation, which may include inhomogeneities and cyclic behavior.

Method: Generalization of the BGV theorem to inhomogeneous and cyclic models, using specific examples like the Ijjas-Steinhardt cyclic model.

Result: It is demonstrated that the cyclic model proposed by Ijjas and Steinhardt exhibits geodesic incompleteness, similar to the behavior observed in inflationary spacetimes.

Conclusion: The Borde-Guth-Vilenkin Theorem is extended to non-inflationary spacetimes, revealing that cyclic models can also be geodesically incomplete.
...
### [36] [Quantum description of gravitational waves generated by a classical source](https://arxiv.org/abs/2604.20228)
*Felix Laga,Teruaki Suyama*

Main category: gr-qc

TL;DR: This paper explores the quantum behavior of gravitational waves generated by a classical energy-momentum tensor. It shows that the classical wave description is valid for astrophysical sources but may break down at the laboratory scale due to the discrete nature of graviton emission.


<details>
  <summary>Details</summary>
Motivation: To understand the quantum properties of gravitational waves and to establish a criterion for the validity of the classical wave description in different scales.

Method: The paper investigates the quantum properties of gravitational waves generated by a classical energy-momentum tensor. It treats the GW field as a quantum field coupled to a classical source and evaluates the expectation value of the GW operator. The mean and variance of the number of emitted gravitons are shown to be equal, suggesting a Poisson process. A quantitative criterion for the validity of the classical wave description is established and applied to assess the accuracy of the classical approximation.

Result: The expectation value of the GW operator exactly reproduces the classical retarded solution. The mean and variance of the number of emitted gravitons are equal, indicating a Poisson process. The classical approximation is found to be accurate for astrophysical sources but may not hold in laboratory-scale systems due to the discrete nature of graviton emission.

Conclusion: The classical wave description of gravitational waves is remarkably accurate for astrophysical sources, but the discrete nature of graviton emission becomes significant in laboratory-scale systems.
...
### [37] [Reshaping the inner shadow of a Kerr black hole by a torn accretion disk](https://arxiv.org/abs/2604.20499)
...
### [38] [Astrophysically Realistic Secondary Spins Trigger Chaos in Schwarzschild Spacetime and Discernible Gravitational Wave Signatures](https://arxiv.org/abs/2604.20533)
*Dan-Dan Yuan,Jia-Geng Jiao,Yu-Qi Lei,Jun-Xi Shi,Jing-Qi Lai,Caiying Shao,Yu Tian*

Main category: gr-qc

TL;DR: This paper shows that chaos in extreme-mass-ratio inspirals can occur within realistic spin ranges and produces distinguishable gravitational wave signatures, including a more complex frequency-domain structure and a higher local spectral-flatness measure for chaotic signals. A slight change in the secondary spin can induce a transition from regular to chaotic motion, generating unique detector-level waveforms.


<details>
  <summary>Details</summary>
Motivation: Previous studies have suggested that chaos in extreme-mass-ratio inspirals might require unrealistically large secondary spins, casting doubt on its astrophysical relevance. This paper aims to address this by showing that chaos can persist within the realistic spin range and provides clear evidence through the analysis of gravitational wave signatures.

Method: The research employs numerical simulations to investigate the dynamics of extreme-mass-ratio inspirals, focusing on the effects of secondary spin on the emitted gravitational waves. The analysis includes the introduction of a local spectral-flatness measure to quantify the frequency-domain structure of the gravitational wave signals.

Result: The findings reveal that nearby regular and chaotic trajectories can appear similar in the time domain but differ significantly in their frequency-domain structure. Chaotic signals exhibit a less discrete frequency-domain structure with dense inter-peak power, while the local spectral-flatness measure is several hundred times larger for chaotic signals than for regular ones. Additionally, a minimal change in the secondary spin can switch the system from regular to chaotic behavior, leading to distinctive detector-level waveforms.

Conclusion: The study demonstrates that chaos in extreme-mass-ratio inspirals persists across the astrophysically realistic spin range for a spinning secondary orbiting a Schwarzschild black hole. This nonintegrable dynamics results in distinct gravitational wave signatures, including a local spectral-flatness measure that is significantly larger for chaotic signals compared to regular ones. A small change in the secondary spin can drive the system from regular to chaotic motion, producing unique detector-level waveforms.
...
### [39] [Time evolution of a Nambu-Goto string coiling around a Kerr black hole](https://arxiv.org/abs/2604.20656)
...
### [40] [Time Like Geodesics of Regular Black Holes with Scalar Hair](https://arxiv.org/abs/2604.20661)
...
### [41] [General Relativity via differential forms -- explorations in Plebanski's Formalism for GR](https://arxiv.org/abs/2604.20772)
*Adam Shaw*
...
### [42] [Supersymmetry, Supergravity and Non--Perturbative Dynamics of Gauge Theories](https://arxiv.org/abs/2604.19817)
*Tetiana Obikhod*
...
### [43] [The emergence of (3+1)-dimensional expanding spacetime from complex Langevin simulations of the Lorentzian type IIB matrix model with deformations](https://arxiv.org/abs/2604.19836)
...
### [44] [Mutual Information from Modular Flow in General CFTs](https://arxiv.org/abs/2604.19860)
...
### [45] [Excitability in quantum field theory](https://arxiv.org/abs/2604.19861)
*Jacqueline Caminiti,Federico Capeccia,Jonathan Sorce*

Main category: hep-th

TL;DR: This paper develops criteria for (local) excitability in quantum theories and applies them to Gaussian states in free field theories, showing that one-way excitability implies two-way excitability and generalizing previous theorems. The proof uses canonical purification as a key tool.


<details>
  <summary>Details</summary>
Motivation: In quantum field theory, it is not always possible to excite one state out of another using only local operators. This paper aims to address this issue by providing a framework for understanding (local) excitability through abstract algebraic criteria and applying this framework to zero-mean Gaussian states in (generalized) free field theories.

Method: The method involves establishing abstract algebraic criteria for (local) excitability and computing these criteria explicitly for zero-mean Gaussian states in (generalized) free field theories. The key role in the proof is played by the information-theoretic tool of canonical purification.

Result: The results show that in the context of Gaussian states, one-way excitability always implies two-way excitability, and the findings generalize the 'quasiequivalence theorems'. Appendices provide a pedagogical introduction to the algebraic formulation of (generalized) free field theory.

Conclusion: The paper establishes abstract algebraic criteria for (local) excitability in general quantum theories and computes these criteria explicitly for zero-mean Gaussian states in (generalized) free field theories. It is shown that one-way excitability always implies two-way excitability in the context of Gaussian states, generalizing the 'quasiequivalence theorems' of Powers, Stormer, van Daele, Araki, and Yamagami. The proof relies crucially on the information-theoretic tool of canonical purification.
...
### [46] [Asymptotic charges as detectors and the memory effect in massive QED and perturbative quantum gravity](https://arxiv.org/abs/2604.19866)
*Brett Oertel,Ian Moult,Sabrina Pasterski*

Main category: hep-th

TL;DR: The paper reinterprets the existence of asymptotic symmetries in quantum gravity and QED using detectors and full time dependence in Faddeev-Kulish dressings. It corrects literature discrepancies and shows that these dressings accurately capture the memory effect in scattering Fock spaces, with physical contributions to memory eigenvalues.


<details>
  <summary>Details</summary>
Motivation: The motivation is to clarify, confirm, and generalize the existing results on asymptotic symmetries in quantum gravity and QED, particularly concerning dressed states and the inclusion of external hard gravitons. By using detectors and incorporating the full time dependence in Faddeev-Kulish dressings, the paper aims to address inconsistencies in the literature and provide a more comprehensive understanding of the memory effect.

Method: The method involves rederiving the statements about asymptotic symmetries using detectors and including the full time (t) dependence in Faddeev-Kulish dressings. This approach allows for correcting discrepancies in the literature and making new statements regarding the memory effect in scattering Fock spaces.

Result: The result is that Faddeev-Kulish dressings correctly encode the memory effect in the 'in' and 'out' scattering Fock spaces, leading to physical contributions to the memory eigenvalues. This approach resolves discrepancies in the literature and offers new insights into the behavior of asymptotic symmetries under dressing.

Conclusion: The paper rederives the existence of an infinite set of asymptotic symmetries in quantum gravity and QED, extending these to dressed states. It clarifies, confirms, and generalizes these results by incorporating external hard gravitons using detectors and full t dependence in Faddeev-Kulish dressings. The Faddeev-Kulish dressings are shown to correctly encode the memory effect in 'in' and 'out' scattering Fock spaces, with physical contributions to the memory eigenvalues arising from the dressings.
...
### [47] [Crosscap Defects](https://arxiv.org/abs/2604.19868)
...
### [48] [Weyl Anomaly Coefficients of Holographic Defect CFTs at Weak and Strong Coupling](https://arxiv.org/abs/2604.19881)
*George Georgiou*
...
### [49] [On non-relativistic integrable models and 4d SCFTs](https://arxiv.org/abs/2604.19885)
...
### [50] [Black Hole Interiors as a Laboratory for Time-Dependent Classical Double Copy](https://arxiv.org/abs/2604.19920)
...
### [51] [Geometric Amplitudes: A Covariant Functional Approach for Massless Scalar Theories](https://arxiv.org/abs/2604.20099)
...
### [52] [Entropy bound and the non-universality of entanglement islands](https://arxiv.org/abs/2604.20165)
*Naman Kumar*

Main category: hep-th

TL;DR: Entanglement islands resolve the AMPS firewall paradox by modifying the entanglement wedge of Hawking radiation. However, achieving universality requires compatibility with semiclassical entropy bounds, leading to a contradiction and a conditional no-go result for universal compact islands.


<details>
  <summary>Details</summary>
Motivation: To resolve the AMPS firewall paradox using entanglement islands and understand the conditions under which such a resolution can be made universal.

Method: We investigate whether a single compact island can serve as a common interior support for all AMPS-relevant radiation regions by modifying the entanglement wedge of Hawking radiation. We show that such a construction is obstructed under reasonable assumptions, leading to a conditional no-go result for universal compact islands.

Result: We demonstrate that universality forces an accumulation of interior partner entropy within a fixed compact region, which at late times exceeds the Bekenstein--Hawking bound set by its boundary area. This leads to a contradiction, yielding a conditional no-go result for universal compact islands.

Conclusion: Our result implies that interior reconstruction in the island framework must remain intrinsically region-dependent.
...
### [53] [Computational Cosmic Censorship](https://arxiv.org/abs/2604.20170)
...
### [54] [Off-shell recursion for all-loop planar integrands in Yang-Mills theory](https://arxiv.org/abs/2604.20377)
*Yi-Xiao Tao*

Main category: hep-th

TL;DR: We apply the off-shell recursion method to Yang-Mills planar loop integrands, starting with the classical equation of motion. The pure gluon sector is expressed in a matrix formalism, and ghost contributions are included. The full recursion step is derived, and a recursive strategy is concluded for the 2-loop case.


<details>
  <summary>Details</summary>
Motivation: To apply the off-shell recursion method to Yang-Mills planar loop integrands, starting from the classical equation of motion via the perturbiner method. This approach aims to clarify the off-shell structure and explore its potential use in finding amplitude relations at higher-loop levels. Including ghost contributions and considering the 2-loop case provides a comprehensive understanding of the recursion strategy.

Method: The off-shell recursion method is used, beginning with the perturbiner method to solve the classical equation of motion. The recursion steps are followed to express the pure gluon sector in a matrix formalism. Ghost contributions are added, and the complete recursion step is written down. The 2-loop planar integrand recursion is treated as a special case to derive a recursive strategy.

Result: The pure gluon sector of the planar loop integrands is expressed in a matrix formalism, which enhances the clarity of the off-shell structure. The inclusion of ghost contributions allows for the derivation of the full recursion step for the Yang-Mills planar loop integrands. The 2-loop planar integrand recursion is analyzed as a special case, resulting in a recursive strategy.

Conclusion: The off-shell recursion method is applied to the Yang-Mills planar loop integrands, starting with the classical equation of motion. The pure gluon sector is expressed in a matrix formalism, which clarifies the off-shell structure and has potential for higher-loop amplitude relations. Ghost contributions are included, and the full recursion step is derived. A special case of 2-loop planar integrand recursion is considered, leading to a recursive strategy.
...
### [55] [The phase diagram of confining holographic theories on constant curvature manifolds in the presence of a $θ$-angle](https://arxiv.org/abs/2604.20418)
...
### [56] [Complex scaling approach to quasinormal modes of Schwarzschild and Reissner--Nordström black holes](https://arxiv.org/abs/2604.20442)
*Shoya Ogawa,Takuya Hirose,Okuto Morikawa*

Main category: hep-th

TL;DR: We use the complex scaling method to compute quasinormal modes for Schwarzschild and Reissner--Nordström black holes, showing that this method offers a unified and flexible approach.


<details>
  <summary>Details</summary>
Motivation: To study black-hole quasinormal modes by applying the complex scaling method (CSM) to the perturbation equations of Schwarzschild and Reissner--Nordström black holes.

Method: The complex scaling method (CSM) is applied to the perturbation equations of Schwarzschild and Reissner--Nordström black holes. The method converts the outgoing-wave boundary condition into a non-Hermitian eigenvalue problem, allowing quasinormal-mode frequencies to be computed within a common spectral framework.

Result: Our results show that CSM provides a unified and flexible approach to the computation of black-hole quasinormal frequencies.

Conclusion: The complex scaling method (CSM) provides a unified and flexible approach to the computation of black-hole quasinormal frequencies.
...
### [57] [Anisotropic drag force in finite-density QGP from charged rotating 5D black holes](https://arxiv.org/abs/2604.20498)
...
### [58] [Generalized BPS magnetic monopoles in inhomogeneous Yang-Mills-Higgs models](https://arxiv.org/abs/2604.20584)
...
### [59] [Stochastic Krylov Dynamics: Revisiting Operator Growth in Open Quantum Systems](https://arxiv.org/abs/2604.20619)
...
### [60] [Towering Gravitons in AdS$_3$/CFT$_2$](https://arxiv.org/abs/2604.20663)
...
### [61] [Wall-crossing of Instantons on the Blow-up](https://arxiv.org/abs/2604.20674)
...
### [62] [Gravity mediated entanglement of phonons in Bose-Einstein condensates](https://arxiv.org/abs/2604.20767)
...
### [63] [Beyond Hagedorn: A Harmonic Approach to $T\bar{T}$-deformation](https://arxiv.org/abs/2604.20839)
*Jie Gu,Jue Hou,Yunfeng Jiang*

Main category: hep-th

TL;DR: We use harmonic analysis to study the $Tar{T}$-deformed torus partition function, expressing it in terms of Maass waveforms. This allows us to compute the partition function for any $λ$, including beyond the Hagedorn singularity, by proposing an analytic continuation.


<details>
  <summary>Details</summary>
Motivation: The motivation is to understand the behavior of the $Tar{T}$-deformed torus partition function, particularly its analytic structure as a function of the deformation parameter $λ$. Harmonic analysis is chosen because it provides a robust framework for dealing with the complex deformations and singularities that arise in this context.

Method: The method involves expressing CFT partition functions in terms of Maass waveforms, which include Eisenstein series and cusp forms. These basis functions deform under the $Tar{T}$-deformation in a simple manner. The spectral decomposition provides a numerically stable and efficient way to compute the partition function at finite values of $λ$. The resulting deformed partition function shows a Hagedorn singularity, and we propose an analytic continuation to handle this singularity.

Result: The result is the development of a numerical method to compute the $Tar{T}$-deformed torus partition function for any value of $λ$. This includes resolving the Hagedorn singularity through an analytic continuation. The spectral decomposition method is shown to be numerically stable and efficient for finite values of $λ$.

Conclusion: We have developed a method to study the $Tar{T}$-deformed torus partition function using harmonic analysis. This approach allows us to compute the partition function for any value of the deformation parameter $λ$, including beyond the Hagedorn singularity, by proposing an analytic continuation.
...
### [64] [Measuring neutrino mass and asymmetry through galaxy pairwise peculiar velocity](https://arxiv.org/abs/2604.19922)
...
### [65] [Purely Quadratic Non-Gaussianity from Tachyonic Instability: Primordial Black Holes and Scalar-Induced Gravitational Waves](https://arxiv.org/abs/2604.20063)
...
### [66] [Forecasts of CMB $E$-mode anomalies for AliCPT-1](https://arxiv.org/abs/2604.20699)
