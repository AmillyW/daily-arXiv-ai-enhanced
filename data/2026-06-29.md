...
### [42] [Construction of Sensitivity Curves for Dynamic LISA and Taiji](https://arxiv.org/abs/2606.28071)
...
### [43] [Superradiant Instability and Two Classes of Scalar Clouds around Kerr-Bertotti-Robinson Black Holes](https://arxiv.org/abs/2606.27958)
...
### [44] [Probing Two Dark Dimensions through Primordial Black Holes, Gravitational Waves, and Colliders](https://arxiv.org/abs/2606.27992)
...
### [45] [Generalizing the interacting dilatonic ghost condensate as a dark energy model](https://arxiv.org/abs/2606.28288)
...
### [46] [Revisit Static Aether: Exact Vacuum Solution in Einstein-Aether Theory and Its Analytic Extension](https://arxiv.org/abs/2606.27995)
*Jie Zhu,Hao Li*
...
### [47] [Joint inference of line-of-sight acceleration and orbital eccentricity in neutron-star--black-hole binaries](https://arxiv.org/abs/2606.28156)
...
### [48] [Finite Coherence in Gravitational Waves from Tidally Excited Axion Clouds](https://arxiv.org/abs/2606.28161)
...
### [49] [Gravitational-wave response functions for space-borne detectors based on multiple geometric time-delay interferometry links](https://arxiv.org/abs/2606.28173)
...
### [50] [Nonlinear stability of subextremal Kerr black holes](https://arxiv.org/abs/2606.28253)
*Peter Hintz*
...
### [51] [Unveiling the Microhertz Gravitational-Wave Sky with the Square Kilometre Array Observatory](https://arxiv.org/abs/2606.27418)
...
### [52] [Three-form dark energy: constraints and multi-probe comparison with $Λ$CDM](https://arxiv.org/abs/2606.27436)
...
### [53] [Simulation-Based Inference for Cluster Cosmology with Set-Based Neural Network Architectures](https://arxiv.org/abs/2606.27439)
...
### [54] [Fast Radio Bursts as Cosmological Probes](https://arxiv.org/abs/2606.27714)
...
### [55] [Inferring Cosmology and Astrophysics from the High-redshift 21cm Signal with SKA-Low](https://arxiv.org/abs/2606.27858)
...
### [56] [A hidden reionization prior biases cosmological inference](https://arxiv.org/abs/2606.27903)
...
### [57] [Large-scale structures of the Universe: physics, phenomenology, statistics](https://arxiv.org/abs/2606.27927)
*Cora Uhlemann*
...
### [58] [UV artefacts in ultra-slow-roll models of inflation](https://arxiv.org/abs/2606.28005)
...
### [59] [Dark energy perturbations and the robustness of cosmological neutrino-mass constraints](https://arxiv.org/abs/2606.28074)
...
### [60] [Thermal Sunyaev-Zel'dovich cross-correlations with unWISE galaxies: disentangling radio contamination, dust properties, and electron pressure](https://arxiv.org/abs/2606.28099)
...
### [61] [The effect of dark energy on the void-halo perpendicular alignments](https://arxiv.org/abs/2606.28151)
...
### [62] [Searching for primordial features with radio surveys: synergy between the power spectrum and bispectrum](https://arxiv.org/abs/2606.28172)
...
### [63] [HIcosmo: a differentiable JAX-based framework for cosmology inference](https://arxiv.org/abs/2606.28175)
...
### [64] [Cancellation of one-loop time dependence in superhorizon curvature perturbations from all scales](https://arxiv.org/abs/2606.28247)
*Keisuke Inomata*
...
### [65] [Memoirs of the curvaton: non-perturbative non-Gaussianity and supermassive primordial black holes](https://arxiv.org/abs/2606.28296)
...
### [66] [First results of sub-arcsecond scale objects identified with ASKAP using interplanetary scintillation](https://arxiv.org/abs/2606.28302)
...
### [67] [Constraining primordial oscillations and inflationary particle production with Planck, ACT DR6, and DESI DR2](https://arxiv.org/abs/2606.28310)
...
### [68] [Superoscillatory initial states during inflation: theory, CMB constraints, and prospects for galaxy clustering](https://arxiv.org/abs/2606.25133)
*Ali Nayeri*
...
### [69] [Observing Massive Scattering from Null Infinity](https://arxiv.org/abs/2606.27421)
...
### [70] [Free-Field Construction of Heterotic String Compactified on Calabi-Yau Orbifolds via Correspondence with $\mathcal{N}{=}2$ SCFT Minimal Models](https://arxiv.org/abs/2606.27490)
...
### [71] [Soft QED as Open Quantum System: Infrared Cancellation and Soft-Shell Coarse Graining](https://arxiv.org/abs/2606.27498)
*Soo-Jong Rey*
...
### [72] [Gravitational wave scattering at $\mathcal{O}(G^4)$: Murua construction and elliptics](https://arxiv.org/abs/2606.27544)
...
### [73] [CIPro Package: Complete Intersections in Products of Projective Spaces and Line Bundles](https://arxiv.org/abs/2606.27588)
...
### [74] [Classification of Killing Horizons in D=11 Supergravity](https://arxiv.org/abs/2606.27843)
...
### [75] [Tree-level S matrix for $λ$-deformed AdS3 strings](https://arxiv.org/abs/2606.27846)
...
### [76] [A UV-Finite Ryu-Takayanagi Relation from Relative Entropy in AdS$_3$/CFT$_2$](https://arxiv.org/abs/2606.27915)
...
### [77] [The two-dimensional disordered $O(N)$ sigma model](https://arxiv.org/abs/2606.27925)
...
### [78] [$\texttt{SMaSH}$ : Simplify Massive Spinor Helicity](https://arxiv.org/abs/2606.27928)
...
### [79] [Quantum black hole cohomologies](https://arxiv.org/abs/2606.27955)
...
### [80] [Planar loop integrands from cuts in $D$ dimensions](https://arxiv.org/abs/2606.28052)
...
### [81] [New Solutions of RG Equations for α_s and y_{top}](https://arxiv.org/abs/2606.28084)
...
### [82] [Abelian Orbifolds for Brane Brick Models](https://arxiv.org/abs/2606.28110)
...
### [83] [Configurational Temperature in Matrix Models and Random Matrix Ensembles](https://arxiv.org/abs/2606.28148)
...
### [84] [Large Quantum Gravity Fluctuations of BTZ Black Holes](https://arxiv.org/abs/2606.28160)
...
### [85] [Quantum anomalies from three-point on-shell bootstrap](https://arxiv.org/abs/2606.28193)
...
### [86] [Non-primary square roots in massive gravity](https://arxiv.org/abs/2606.28208)
*Alexey Golovnev*
...
### [87] [Higher dimensional quantum Hall effect and the analog of $W_\infty$-algebra](https://arxiv.org/abs/2606.28219)
...
### [88] [Multi--black holes in Bertotti--Robinson spacetime](https://arxiv.org/abs/2606.28232)
...
### [89] [Gravitational Compton scattering at the fourth post-Minkowskian order](https://arxiv.org/abs/2606.28239)
...
### [90] [Quantum Fluctuations of the Black Hole Horizon](https://arxiv.org/abs/2606.28243)
...
### [91] [Spinor-helicity formalism for continuous-spin particles](https://arxiv.org/abs/2606.28245)
...
### [92] [The cosmology of long range Yukawa interactions in general backgrounds](https://arxiv.org/abs/2606.28246)
...
### [93] [Surface Water Wave Scattering and the Hydrotope](https://arxiv.org/abs/2606.28280)
